...
static const char * c11_c_debug_family_names[23] = { "theta1", "f1", "theta2",
...
static const char * c11_d_debug_family_names[15] = { "hsd", "i", "nargin",
  "nargout", "input", "preinput", "Fxref", "Fyref", "Mref", "rx1", "rx2", "ry1",
  "ry2", "C", "output" };

static const char * c11_e_debug_family_names[22] = { "theta1", "f1", "theta2",
  "f2", "pretheta1", "pretheta2", "Fx", "Fy", "M", "nargin", "nargout", "input",
  "preinput", "Fxref", "Fyref", "Mref", "rx1", "rx2", "ry1", "ry2", "C",
  "output" };

static const char * c11_f_debug_family_names[19] = { "alpha", "u0", "u1", "v0",
  "v1", "nargin", "nargout", "input", "preinput", "h", "Fxref", "Fyref", "Mref",
  "rx1", "rx2", "ry1", "ry2", "C", "output" };

static const char * c11_g_debug_family_names[5] = { "nargin", "nargout", "input",
  "bound", "output" };

static const char * c11_h_debug_family_names[7] = { "k", "i", "nargin",
  "nargout", "input", "inputBound", "output" };

/* Function Declarations */
static void initialize_c11_BoatLibraryTest01
  (SFc11_BoatLibraryTest01InstanceStruct *chartInstance);
static void initialize_params_c11_BoatLibraryTest01
  (SFc11_BoatLibraryTest01InstanceStruct *chartInstance);
static void enable_c11_BoatLibraryTest01(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void disable_c11_BoatLibraryTest01(SFc11_BoatLibraryTest01InstanceStruct *
  chartInstance);
static void c11_update_debugger_state_c11_BoatLibraryTest01
  (SFc11_BoatLibraryTest01InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c11_BoatLibraryTest01
  (SFc11_BoatLibraryTest01InstanceStruct *chartInstance);
static void set_sim_state_c11_BoatLibraryTest01
  (SFc11_BoatLibraryTest01InstanceStruct *chartInstance, const mxArray *c11_st);
static void finalize_c11_BoatLibraryTest01(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void sf_c11_BoatLibraryTest01(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void c11_chartstep_c11_BoatLibraryTest01
  (SFc11_BoatLibraryTest01InstanceStruct *chartInstance);
static void initSimStructsc11_BoatLibraryTest01
  (SFc11_BoatLibraryTest01InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c11_machineNumber, uint32_T
  c11_chartNumber);
static const mxArray *c11_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_emlrt_marshallIn(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c11_output, const char_T *c11_identifier,
  real_T c11_y[4]);
static void c11_b_emlrt_marshallIn(SFc11_BoatLibraryTest01InstanceStruct
...
static const mxArray *c11_d_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static real_T c11_c_emlrt_marshallIn(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static const mxArray *c11_e_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_d_emlrt_marshallIn(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId,
  real_T c11_y[20]);
static void c11_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static void c11_e_emlrt_marshallIn(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId,
  real_T c11_y[7]);
static void c11_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static void c11_f_emlrt_marshallIn(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId,
  real_T c11_y[8]);
...
static const mxArray *c11_f_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_g_emlrt_marshallIn(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId,
  real_T c11_y[5]);
...
static const mxArray *c11_g_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_h_emlrt_marshallIn(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId,
  real_T c11_y[2]);
...
static void c11_eml_scalar_eg(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void c11_linspace(SFc11_BoatLibraryTest01InstanceStruct *chartInstance,
  real_T c11_d1, real_T c11_d2, real_T c11_y[5]);
static void c11_SteepestDescent(SFc11_BoatLibraryTest01InstanceStruct
...
static real_T c11_cosd(SFc11_BoatLibraryTest01InstanceStruct *chartInstance,
  real_T c11_x);
static boolean_T c11_isfinite(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, real_T c11_x);
static real_T c11_sind(SFc11_BoatLibraryTest01InstanceStruct *chartInstance,
  real_T c11_x);
static real_T c11_costFunction(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, real_T c11_input[4], real_T c11_preinput[4], real_T c11_Fxref,
  real_T c11_Fyref, real_T c11_Mref, real_T c11_rx1, real_T c11_rx2, real_T
  c11_ry1, real_T c11_ry2, real_T c11_C[7]);
static real_T c11_mpower(SFc11_BoatLibraryTest01InstanceStruct *chartInstance,
  real_T c11_a);
static const mxArray *c11_h_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static int32_T c11_i_emlrt_marshallIn(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static uint8_T c11_j_emlrt_marshallIn(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c11_b_is_active_c11_BoatLibraryTest01, const
  char_T *c11_identifier);
static uint8_T c11_k_emlrt_marshallIn(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_b_cosd(SFc11_BoatLibraryTest01InstanceStruct *chartInstance,
  real_T *c11_x);
static void c11_b_sind(SFc11_BoatLibraryTest01InstanceStruct *chartInstance,
  real_T *c11_x);
static void init_dsm_address_info(SFc11_BoatLibraryTest01InstanceStruct
  *chartInstance);
  ...
  (SFc11_BoatLibraryTest01InstanceStruct *chartInstance)
{
  ...
  chartInstance->c11_is_active_c11_BoatLibraryTest01 = 0U;
}
  ...
  (SFc11_BoatLibraryTest01InstanceStruct *chartInstance)
{
  ...
  c11_hoistedGlobal = chartInstance->c11_is_active_c11_BoatLibraryTest01;
  ...
  (SFc11_BoatLibraryTest01InstanceStruct *chartInstance, const mxArray *c11_st)
{
  ...
  chartInstance->c11_is_active_c11_BoatLibraryTest01 = c11_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c11_u, 1)),
     "is_active_c11_BoatLibraryTest01");
  sf_mex_destroy(&c11_u);
  c11_update_debugger_state_c11_BoatLibraryTest01(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c11_sfEvent = CALL_EVENT;
  c11_chartstep_c11_BoatLibraryTest01(chartInstance);
  ...
  (SFc11_BoatLibraryTest01InstanceStruct *chartInstance)
{
  ...
  for (c11_i11 = 0; c11_i11 < 5; c11_i11++) {
  ...
  for (c11_i16 = 0; c11_i16 < 5; c11_i16++) {
    c11_grid[c11_i16 + 5] = c11_f1[c11_i16];
  }

  for (c11_i17 = 0; c11_i17 < 5; c11_i17++) {
    c11_grid[c11_i17 + 10] = c11_theta2[c11_i17];
  }

  for (c11_i18 = 0; c11_i18 < 5; c11_i18++) {
    c11_grid[c11_i18 + 15] = c11_f2[c11_i18];
  }
  ...
  while (c11_b_k < 100) {
    ...
    for (c11_i20 = 0; c11_i20 < 4; c11_i20++) {
      c11_input[c11_i20] = c11_u1[c11_i20];
    }

    for (c11_i21 = 0; c11_i21 < 4; c11_i21++) {
      c11_preinput[c11_i21] = c11_u0[c11_i21];
    }
    ...
    for (c11_i22 = 0; c11_i22 < 7; c11_i22++) {
      c11_b_C[c11_i22] = c11_C[c11_i22];
    }

    _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 15U, 15U, c11_d_debug_family_names,
      c11_c_debug_family_var_map);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_hsd, 0U, c11_sf_marshallOut,
      c11_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_i, 1U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_input, 4U, c11_sf_marshallOut,
      c11_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_preinput, 5U, c11_sf_marshallOut,
      c11_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_b_Fxref, 6U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_b_Fyref, 7U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_b_Mref, 8U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_b_rx1, 9U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_b_rx2, 10U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_b_ry1, 11U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_b_ry2, 12U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_b_C, 13U, c11_d_sf_marshallOut,
      c11_d_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_h, 14U, c11_sf_marshallOut,
      c11_sf_marshallIn);
    CV_EML_FCN(0, 7);
    _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 146U);
    for (c11_i23 = 0; c11_i23 < 4; c11_i23++) {
      c11_b_input[c11_i23] = c11_input[c11_i23];
    }

    for (c11_i24 = 0; c11_i24 < 4; c11_i24++) {
      c11_b_preinput[c11_i24] = c11_preinput[c11_i24];
    }

    for (c11_i25 = 0; c11_i25 < 7; c11_i25++) {
      c11_c_C[c11_i25] = c11_b_C[c11_i25];
    }

    c11_SteepestDescent(chartInstance, c11_b_input, c11_b_preinput, c11_b_Fxref,
                        c11_b_Fyref, c11_b_Mref, c11_b_rx1, c11_b_rx2, c11_b_ry1,
                        c11_b_ry2, c11_c_C, c11_dv2);
    for (c11_i26 = 0; c11_i26 < 4; c11_i26++) {
      c11_hsd[c11_i26] = c11_dv2[c11_i26];
    }

    _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 148U);
    for (c11_i27 = 0; c11_i27 < 4; c11_i27++) {
      c11_h[c11_i27] = 0.0;
    }

    _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 150U);
    c11_i = 1.0;
    c11_b_i = 0;
    while (c11_b_i < 4) {
      ...
      c11_h[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("output", (int32_T)
        _SFD_INTEGER_CHECK("i", c11_i), 1, 4, 1, 0) - 1] = c11_hsd[(int32_T)
    ...
    CV_EML_FOR(0, 1, 6, 0);
    _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, -151);
    _SFD_SYMBOL_SCOPE_POP();
    _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 20);
    for (c11_i28 = 0; c11_i28 < 4; c11_i28++) {
      c11_c_input[c11_i28] = c11_u1[c11_i28];
    }

    for (c11_i29 = 0; c11_i29 < 4; c11_i29++) {
      c11_c_preinput[c11_i29] = c11_u0[c11_i29];
    }

    for (c11_i30 = 0; c11_i30 < 4; c11_i30++) {
      c11_b_h[c11_i30] = c11_h[c11_i30];
    }
    ...
    for (c11_i31 = 0; c11_i31 < 7; c11_i31++) {
      c11_d_C[c11_i31] = c11_C[c11_i31];
    }

    _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 19U, 19U, c11_f_debug_family_names,
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_b_u1, 2U, c11_sf_marshallOut,
      c11_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_v0, 3U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_v1, 4U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_d_nargout, 6U,
      c11_b_sf_marshallOut, c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_c_input, 7U, c11_sf_marshallOut,
      c11_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_c_preinput, 8U, c11_sf_marshallOut,
      c11_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_b_h, 9U, c11_sf_marshallOut,
      c11_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_c_Fxref, 10U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_c_Fyref, 11U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_c_Mref, 12U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_c_rx1, 13U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_c_rx2, 14U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_c_ry1, 15U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_c_ry2, 16U, c11_b_sf_marshallOut,
      c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_d_C, 17U, c11_d_sf_marshallOut,
      c11_d_sf_marshallIn);
    ...
    for (c11_i32 = 0; c11_i32 < 4; c11_i32++) {
      c11_b_u0[c11_i32] = c11_c_input[c11_i32];
    }

    _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 92);
    for (c11_i33 = 0; c11_i33 < 4; c11_i33++) {
      c11_b[c11_i33] = c11_b_h[c11_i33];
    }

    for (c11_i34 = 0; c11_i34 < 4; c11_i34++) {
      c11_b_u1[c11_i34] = c11_c_input[c11_i34] + c11_b[c11_i34];
    }

    _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 94);
    for (c11_i35 = 0; c11_i35 < 4; c11_i35++) {
      c11_c_u0[c11_i35] = c11_b_u0[c11_i35];
    }

    for (c11_i36 = 0; c11_i36 < 4; c11_i36++) {
      c11_d_preinput[c11_i36] = c11_c_preinput[c11_i36];
    }

    for (c11_i37 = 0; c11_i37 < 7; c11_i37++) {
      c11_e_C[c11_i37] = c11_d_C[c11_i37];
    }

    c11_v0 = c11_costFunction(chartInstance, c11_c_u0, c11_d_preinput,
      c11_c_Fxref, c11_c_Fyref, c11_c_Mref, c11_c_rx1, c11_c_rx2, c11_c_ry1,
      c11_c_ry2, c11_e_C);
    _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 95);
    for (c11_i38 = 0; c11_i38 < 4; c11_i38++) {
      c11_c_u1[c11_i38] = c11_b_u1[c11_i38];
    }

    for (c11_i39 = 0; c11_i39 < 4; c11_i39++) {
      c11_e_preinput[c11_i39] = c11_c_preinput[c11_i39];
    }

    for (c11_i40 = 0; c11_i40 < 7; c11_i40++) {
      c11_f_C[c11_i40] = c11_d_C[c11_i40];
    }

    c11_v1 = c11_costFunction(chartInstance, c11_c_u1, c11_e_preinput,
      c11_c_Fxref, c11_c_Fyref, c11_c_Mref, c11_c_rx1, c11_c_rx2, c11_c_ry1,
      c11_c_ry2, c11_f_C);
    _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 97);
    exitg2 = FALSE;
    while ((exitg2 == FALSE) && (c11_v1 <= c11_v0)) {
      if (c11_v1 != 0.0) {
        ...
        for (c11_i43 = 0; c11_i43 < 4; c11_i43++) {
          c11_b_u1[c11_i43] = c11_c_input[c11_i43] + c11_b[c11_i43];
        }
        ...
        for (c11_i44 = 0; c11_i44 < 4; c11_i44++) {
          c11_d_u1[c11_i44] = c11_b_u1[c11_i44];
        }

        for (c11_i45 = 0; c11_i45 < 4; c11_i45++) {
          c11_f_preinput[c11_i45] = c11_c_preinput[c11_i45];
        }

        for (c11_i46 = 0; c11_i46 < 7; c11_i46++) {
          c11_g_C[c11_i46] = c11_d_C[c11_i46];
        }

        c11_v1 = c11_costFunction(chartInstance, c11_d_u1, c11_f_preinput,
          c11_c_Fxref, c11_c_Fyref, c11_c_Mref, c11_c_rx1, c11_c_rx2, c11_c_ry1,
          c11_c_ry2, c11_g_C);
        _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 97);
        _SF_MEX_LISTEN_FOR_CTRL_C(chartInstance->S);
    ...
    exitg1 = FALSE;
    while ((exitg1 == FALSE) && (c11_v1 <= c11_v0)) {
      if (c11_b_alpha > 0.0) {
        if (c11_v1 != 0.0) {
          CV_EML_WHILE(0, 1, 1, TRUE);
          _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 107);
          c11_b_alpha -= 0.01;
          _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 108);
          c11_b_a = c11_b_alpha;
          for (c11_i47 = 0; c11_i47 < 4; c11_i47++) {
            c11_b[c11_i47] = c11_b_h[c11_i47];
          }

          for (c11_i48 = 0; c11_i48 < 4; c11_i48++) {
            c11_b[c11_i48] *= c11_b_a;
          }

          for (c11_i49 = 0; c11_i49 < 4; c11_i49++) {
            c11_b_u1[c11_i49] = c11_c_input[c11_i49] + c11_b[c11_i49];
          }
          ...
          for (c11_i50 = 0; c11_i50 < 4; c11_i50++) {
            c11_e_u1[c11_i50] = c11_b_u1[c11_i50];
          }

          for (c11_i51 = 0; c11_i51 < 4; c11_i51++) {
            c11_g_preinput[c11_i51] = c11_c_preinput[c11_i51];
          }

          for (c11_i52 = 0; c11_i52 < 7; c11_i52++) {
            c11_h_C[c11_i52] = c11_d_C[c11_i52];
          }

          c11_v1 = c11_costFunction(chartInstance, c11_e_u1, c11_g_preinput,
            c11_c_Fxref, c11_c_Fyref, c11_c_Mref, c11_c_rx1, c11_c_rx2,
            c11_c_ry1, c11_c_ry2, c11_h_C);
          _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 106);
          _SF_MEX_LISTEN_FOR_CTRL_C(chartInstance->S);
        } else {
          exitg1 = TRUE;
    ...
    for (c11_i53 = 0; c11_i53 < 4; c11_i53++) {
      c11_b[c11_i53] = c11_h[c11_i53];
    }

    for (c11_i54 = 0; c11_i54 < 4; c11_i54++) {
      c11_b[c11_i54] *= c11_c_a;
    }

    for (c11_i55 = 0; c11_i55 < 4; c11_i55++) {
      c11_u1[c11_i55] += c11_b[c11_i55];
    }

    _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 22);
    for (c11_i56 = 0; c11_i56 < 4; c11_i56++) {
      c11_d_input[c11_i56] = c11_u1[c11_i56];
    }

    for (c11_i57 = 0; c11_i57 < 8; c11_i57++) {
      c11_c_inputBound[c11_i57] = c11_inputBound[c11_i57];
    }

    _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 7U, 7U, c11_h_debug_family_names,
      c11_e_debug_family_var_map);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_c_k, 0U, c11_sf_marshallOut,
      c11_sf_marshallIn);
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_e_nargout, 3U,
      c11_b_sf_marshallOut, c11_b_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_d_input, 4U, c11_sf_marshallOut,
      c11_sf_marshallIn);
    ...
    while (c11_d_i < 4) {
      ...
      c11_e_input = c11_d_input[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK(
        "input", (int32_T)_SFD_INTEGER_CHECK("i", c11_c_i), 1, 4, 1, 0) - 1];
      c11_e_i = (int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("inputBound",
        (int32_T)_SFD_INTEGER_CHECK("i", c11_c_i), 1, 4, 1, 0) - 1;
      for (c11_i59 = 0; c11_i59 < 2; c11_i59++) {
        c11_bound[c11_i59] = c11_c_inputBound[c11_e_i + (c11_i59 << 2)];
      }
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_f_nargout, 1U,
        c11_b_sf_marshallOut, c11_b_sf_marshallIn);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_e_input, 2U,
        c11_b_sf_marshallOut, c11_b_sf_marshallIn);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c11_bound, 3U, c11_g_sf_marshallOut,
        c11_g_sf_marshallIn);
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c11_b_output, 4U,
        c11_b_sf_marshallOut, c11_b_sf_marshallIn);
      CV_EML_FCN(0, 4);
      _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 77);
      if (CV_EML_IF(0, 1, 1, c11_e_input < c11_bound[0])) {
        _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 78);
        c11_b_output = c11_bound[0];
      } else {
        _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 79);
        if (CV_EML_IF(0, 1, 2, c11_e_input > c11_bound[1])) {
          _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 80);
          c11_b_output = c11_bound[1];
        } else {
          _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 82);
          c11_b_output = c11_e_input;
        }
      }

      _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, -82);
      _SFD_SYMBOL_SCOPE_POP();
      c11_c_k[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("k", (int32_T)
        _SFD_INTEGER_CHECK("i", c11_c_i), 1, 4, 1, 0) - 1] = c11_b_output;
      c11_d_i++;
      _SF_MEX_LISTEN_FOR_CTRL_C(chartInstance->S);
    }
    ...
    for (c11_i60 = 0; c11_i60 < 4; c11_i60++) {
      c11_u1[c11_i60] = c11_c_k[c11_i60];
    }
  ...
  for (c11_i61 = 0; c11_i61 < 4; c11_i61++) {
    c11_output[c11_i61] = c11_u1[c11_i61];
  }

  _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, -25);
  _SFD_SYMBOL_SCOPE_POP();
  for (c11_i62 = 0; c11_i62 < 4; c11_i62++) {
    (*c11_c_output)[c11_i62] = c11_output[c11_i62];
  }
  ...
  *c11_inData)
{
  ...
  const mxArray *c11_y = NULL;
  SFc11_BoatLibraryTest01InstanceStruct *chartInstance;
  chartInstance = (SFc11_BoatLibraryTest01InstanceStruct *)chartInstanceVoid;
  c11_mxArrayOutData = NULL;
  for (c11_i63 = 0; c11_i63 < 4; c11_i63++) {
    c11_b_inData[c11_i63] = (*(real_T (*)[4])c11_inData)[c11_i63];
  }
  ...
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData)
{
  ...
  for (c11_i66 = 0; c11_i66 < 4; c11_i66++) {
    (*(real_T (*)[4])c11_outData)[c11_i66] = c11_y[c11_i66];
  }
  ...
  *c11_inData)
{
  ...
  c11_mxArrayOutData = NULL;
  c11_i67 = 0;
  for (c11_i68 = 0; c11_i68 < 2; c11_i68++) {
    for (c11_i69 = 0; c11_i69 < 4; c11_i69++) {
      c11_b_inData[c11_i69 + c11_i67] = (*(real_T (*)[8])c11_inData)[c11_i69 +
        c11_i67];
    }
  ...
  for (c11_i71 = 0; c11_i71 < 2; c11_i71++) {
    for (c11_i72 = 0; c11_i72 < 4; c11_i72++) {
      c11_u[c11_i72 + c11_i70] = c11_b_inData[c11_i72 + c11_i70];
    }
  ...
  *c11_inData)
{
  ...
  for (c11_i73 = 0; c11_i73 < 7; c11_i73++) {
    c11_b_inData[c11_i73] = (*(real_T (*)[7])c11_inData)[c11_i73];
  }

  for (c11_i74 = 0; c11_i74 < 7; c11_i74++) {
    c11_u[c11_i74] = c11_b_inData[c11_i74];
  }
  ...
  *c11_inData)
{
  ...
  for (c11_i76 = 0; c11_i76 < 4; c11_i76++) {
    for (c11_i77 = 0; c11_i77 < 5; c11_i77++) {
      c11_b_inData[c11_i77 + c11_i75] = (*(real_T (*)[20])c11_inData)[c11_i77 +
        c11_i75];
    }
  ...
  for (c11_i79 = 0; c11_i79 < 4; c11_i79++) {
    for (c11_i80 = 0; c11_i80 < 5; c11_i80++) {
      c11_u[c11_i80 + c11_i78] = c11_b_inData[c11_i80 + c11_i78];
    }
  ...
  c11_y = NULL;
  sf_mex_assign(&c11_y, sf_mex_create("y", c11_u, 0, 0U, 1U, 0U, 2, 5, 4), FALSE);
  sf_mex_assign(&c11_mxArrayOutData, c11_y, FALSE);
  return c11_mxArrayOutData;
}
  ...
  real_T c11_y[20])
{
  real_T c11_dv4[20];
  int32_T c11_i81;
  sf_mex_import(c11_parentId, sf_mex_dup(c11_u), c11_dv4, 1, 0, 0U, 1, 0U, 2, 5,
                4);
  for (c11_i81 = 0; c11_i81 < 20; c11_i81++) {
    c11_y[c11_i81] = c11_dv4[c11_i81];
  }
  ...
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData)
{
  ...
  c11_i82 = 0;
  for (c11_i83 = 0; c11_i83 < 4; c11_i83++) {
    for (c11_i84 = 0; c11_i84 < 5; c11_i84++) {
      (*(real_T (*)[20])c11_outData)[c11_i84 + c11_i82] = c11_y[c11_i84 +
        c11_i82];
    }
  ...
  real_T c11_y[7])
{
  ...
  for (c11_i85 = 0; c11_i85 < 7; c11_i85++) {
    c11_y[c11_i85] = c11_dv5[c11_i85];
  }
  ...
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData)
{
  ...
  for (c11_i86 = 0; c11_i86 < 7; c11_i86++) {
    (*(real_T (*)[7])c11_outData)[c11_i86] = c11_y[c11_i86];
  }
  ...
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData)
{
  ...
  for (c11_i89 = 0; c11_i89 < 2; c11_i89++) {
    for (c11_i90 = 0; c11_i90 < 4; c11_i90++) {
      (*(real_T (*)[8])c11_outData)[c11_i90 + c11_i88] = c11_y[c11_i90 + c11_i88];
    }
  ...
  *c11_inData)
{
  ...
  chartInstance = (SFc11_BoatLibraryTest01InstanceStruct *)chartInstanceVoid;
  c11_mxArrayOutData = NULL;
  for (c11_i91 = 0; c11_i91 < 5; c11_i91++) {
    c11_b_inData[c11_i91] = (*(real_T (*)[5])c11_inData)[c11_i91];
  }

  for (c11_i92 = 0; c11_i92 < 5; c11_i92++) {
    c11_u[c11_i92] = c11_b_inData[c11_i92];
  }
  ...
  real_T c11_y[5])
{
  ...
  for (c11_i93 = 0; c11_i93 < 5; c11_i93++) {
    c11_y[c11_i93] = c11_dv7[c11_i93];
  }
  ...
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData)
{
  ...
  for (c11_i94 = 0; c11_i94 < 5; c11_i94++) {
    (*(real_T (*)[5])c11_outData)[c11_i94] = c11_y[c11_i94];
  }
  ...
  *c11_inData)
{
  ...
  for (c11_i95 = 0; c11_i95 < 2; c11_i95++) {
    c11_b_inData[c11_i95] = (*(real_T (*)[2])c11_inData)[c11_i95];
  }

  for (c11_i96 = 0; c11_i96 < 2; c11_i96++) {
    c11_u[c11_i96] = c11_b_inData[c11_i96];
  }
  ...
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData)
{
  ...
  c11_thisId.fIdentifier = c11_identifier;
  c11_thisId.fParent = NULL;
  c11_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c11_bound), &c11_thisId,
    c11_y);
  sf_mex_destroy(&c11_bound);
  for (c11_i98 = 0; c11_i98 < 2; c11_i98++) {
    (*(real_T (*)[2])c11_outData)[c11_i98] = c11_y[c11_i98];
  }

  sf_mex_destroy(&c11_mxArrayInData);
}

const mxArray *sf_c11_BoatLibraryTest01_get_eml_resolved_functions_info(void)
{
...
static void c11_info_helper(const mxArray **c11_info)
{
  ...
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("mtimes"), "name", "name", 16);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 16);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("cosd"), "name", "name", 17);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "context",
                  "context", 21);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("isinf"), "name", "name", 21);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m"), "context",
                  "context", 23);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("isnan"), "name", "name", 23);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_rem90.m"),
                  "context", "context", 29);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("rem"), "name", "name", 29);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 29);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_rem90.m"),
                  "context", "context", 36);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("mtimes"), "name", "name", 36);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m"), "resolved",
  ...
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("sind"), "name", "name", 37);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 37);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("sin"), "name", "name", 39);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 39);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c11_info, sf_mex_duplicatearraysafe(&c11_lhs40), "lhs", "lhs",
                  40);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(""), "context", "context", 41);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("length"), "name", "name", 41);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 41);
  sf_mex_addfield(*c11_info, c11_emlrt_marshallOut(
  ...
  c11_ry1, real_T c11_ry2, real_T c11_C[7], real_T c11_output[4])
{
  ...
  int32_T c11_i99;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 23U, 23U, c11_c_debug_family_names,
    c11_debug_family_var_map);
  ...
  _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 158U);
  c11_f1 = c11_input[1];
  _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 159U);
  c11_theta2 = c11_input[2];
  _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 160U);
  c11_f2 = c11_input[3];
  _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 162U);
  ...
  _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 172U);
  c11_ab_a = c11_C[3];
  c11_ab_b = c11_f1;
  ...
  _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 185U);
  c11_vc_a = c11_C[4];
  c11_vc_b = c11_f2;
  ...
  for (c11_i99 = 0; c11_i99 < 4; c11_i99++) {
    c11_output[c11_i99] = -c11_b_dVdtheta1[c11_i99];
  }

  _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, -191);
  _SFD_SYMBOL_SCOPE_POP();
}
  ...
  c11_ry1, real_T c11_ry2, real_T c11_C[7])
{
  ...
  c11_theta2 = c11_input[2];
  _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, 124);
  c11_f2 = c11_input[3];
  ...
  c11_output = (((((c11_m_y + c11_n_y) + c11_o_y) + c11_p_y) + c11_q_y) +
                c11_r_y) + c11_s_y;
  _SFD_EML_CALL(0U, chartInstance->c11_sfEvent, -134);
  _SFD_SYMBOL_SCOPE_POP();
  return c11_output;
}
  ...
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId)
{
  int32_T c11_y;
  int32_T c11_i100;
  sf_mex_import(c11_parentId, sf_mex_dup(c11_u), &c11_i100, 1, 6, 0U, 0, 0U, 0);
  c11_y = c11_i100;
  sf_mex_destroy(&c11_u);
  return c11_y;
}
  ...
  char_T *c11_identifier)
{
  ...
  c11_y = c11_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c11_b_is_active_c11_BoatLibraryTest01), &c11_thisId);
  sf_mex_destroy(&c11_b_is_active_c11_BoatLibraryTest01);
  return c11_y;
}
...
void sf_c11_BoatLibraryTest01_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c11_BoatLibraryTest01_get_autoinheritance_info(void)
{
...
mxArray *sf_c11_BoatLibraryTest01_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c11_BoatLibraryTest01_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c11_BoatLibraryTest01(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"output\",},{M[8],M[0],T\"is_active_c11_BoatLibraryTest01\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c11_BoatLibraryTest01_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc11_BoatLibraryTest01InstanceStruct *chartInstance;
    chartInstance = (SFc11_BoatLibraryTest01InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c11_BoatLibraryTest01(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc11_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c11_BoatLibraryTest01((SFc11_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
  initialize_c11_BoatLibraryTest01((SFc11_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c11_BoatLibraryTest01(void *chartInstanceVar)
{
  enable_c11_BoatLibraryTest01((SFc11_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c11_BoatLibraryTest01(void *chartInstanceVar)
{
  disable_c11_BoatLibraryTest01((SFc11_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c11_BoatLibraryTest01(void *chartInstanceVar)
{
  sf_c11_BoatLibraryTest01((SFc11_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c11_BoatLibraryTest01(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c11_BoatLibraryTest01
    ((SFc11_BoatLibraryTest01InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c11_BoatLibraryTest01();/* state var info */
...
extern void sf_internal_set_sim_state_c11_BoatLibraryTest01(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c11_BoatLibraryTest01((SFc11_BoatLibraryTest01InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c11_BoatLibraryTest01(SimStruct* S)
{
  return sf_internal_get_sim_state_c11_BoatLibraryTest01(S);
}

static void sf_opaque_set_sim_state_c11_BoatLibraryTest01(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c11_BoatLibraryTest01(S, st);
}

static void sf_opaque_terminate_c11_BoatLibraryTest01(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc11_BoatLibraryTest01InstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c11_BoatLibraryTest01((SFc11_BoatLibraryTest01InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc11_BoatLibraryTest01((SFc11_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c11_BoatLibraryTest01(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c11_BoatLibraryTest01
      ((SFc11_BoatLibraryTest01InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c11_BoatLibraryTest01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c11_BoatLibraryTest01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c11_BoatLibraryTest01(SimStruct *S)
{
  SFc11_BoatLibraryTest01InstanceStruct *chartInstance;
  chartInstance = (SFc11_BoatLibraryTest01InstanceStruct *)utMalloc(sizeof
    (SFc11_BoatLibraryTest01InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc11_BoatLibraryTest01InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c11_BoatLibraryTest01;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c11_BoatLibraryTest01;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c11_BoatLibraryTest01;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c11_BoatLibraryTest01;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c11_BoatLibraryTest01;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c11_BoatLibraryTest01;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c11_BoatLibraryTest01;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c11_BoatLibraryTest01;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c11_BoatLibraryTest01;
  chartInstance->chartInfo.mdlStart = mdlStart_c11_BoatLibraryTest01;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c11_BoatLibraryTest01;
...
void c11_BoatLibraryTest01_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c11_BoatLibraryTest01(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c11_BoatLibraryTest01(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c11_BoatLibraryTest01(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c11_BoatLibraryTest01_method_dispatcher.\n"
