...
static void initialize_c13_BoatLibraryTest01
  (SFc13_BoatLibraryTest01InstanceStruct *chartInstance);
static void initialize_params_c13_BoatLibraryTest01
  (SFc13_BoatLibraryTest01InstanceStruct *chartInstance);
static void enable_c13_BoatLibraryTest01(SFc13_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void disable_c13_BoatLibraryTest01(SFc13_BoatLibraryTest01InstanceStruct *
  chartInstance);
static void c13_update_debugger_state_c13_BoatLibraryTest01
  (SFc13_BoatLibraryTest01InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_BoatLibraryTest01
  (SFc13_BoatLibraryTest01InstanceStruct *chartInstance);
static void set_sim_state_c13_BoatLibraryTest01
  (SFc13_BoatLibraryTest01InstanceStruct *chartInstance, const mxArray *c13_st);
static void finalize_c13_BoatLibraryTest01(SFc13_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void sf_c13_BoatLibraryTest01(SFc13_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void initSimStructsc13_BoatLibraryTest01
  (SFc13_BoatLibraryTest01InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c13_machineNumber, uint32_T
  c13_chartNumber);
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_emlrt_marshallIn(SFc13_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c13_y, const char_T *c13_identifier, real_T
  c13_b_y[3]);
static void c13_b_emlrt_marshallIn(SFc13_BoatLibraryTest01InstanceStruct
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_c_emlrt_marshallIn(SFc13_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
...
static const mxArray *c13_c_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_d_emlrt_marshallIn(SFc13_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static uint8_T c13_e_emlrt_marshallIn(SFc13_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_BoatLibraryTest01, const
  char_T *c13_identifier);
static uint8_T c13_f_emlrt_marshallIn(SFc13_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_BoatLibraryTest01InstanceStruct
  *chartInstance);
  ...
  (SFc13_BoatLibraryTest01InstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_BoatLibraryTest01 = 0U;
}
  ...
  (SFc13_BoatLibraryTest01InstanceStruct *chartInstance)
{
  ...
  c13_hoistedGlobal = chartInstance->c13_is_active_c13_BoatLibraryTest01;
  ...
  (SFc13_BoatLibraryTest01InstanceStruct *chartInstance, const mxArray *c13_st)
{
  ...
  chartInstance->c13_is_active_c13_BoatLibraryTest01 = c13_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 1)),
     "is_active_c13_BoatLibraryTest01");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_BoatLibraryTest01(chartInstance);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_BoatLibraryTest01InstanceStruct *chartInstance;
  chartInstance = (SFc13_BoatLibraryTest01InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c13_BoatLibraryTest01_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c13_identifier)
{
  ...
  c13_y = c13_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_BoatLibraryTest01), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_BoatLibraryTest01);
  return c13_y;
}
...
void sf_c13_BoatLibraryTest01_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_BoatLibraryTest01_get_autoinheritance_info(void)
{
...
mxArray *sf_c13_BoatLibraryTest01_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c13_BoatLibraryTest01_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c13_BoatLibraryTest01(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c13_BoatLibraryTest01\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_BoatLibraryTest01_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc13_BoatLibraryTest01InstanceStruct *chartInstance;
    chartInstance = (SFc13_BoatLibraryTest01InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c13_BoatLibraryTest01(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_BoatLibraryTest01((SFc13_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
  initialize_c13_BoatLibraryTest01((SFc13_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c13_BoatLibraryTest01(void *chartInstanceVar)
{
  enable_c13_BoatLibraryTest01((SFc13_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c13_BoatLibraryTest01(void *chartInstanceVar)
{
  disable_c13_BoatLibraryTest01((SFc13_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c13_BoatLibraryTest01(void *chartInstanceVar)
{
  sf_c13_BoatLibraryTest01((SFc13_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_BoatLibraryTest01(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_BoatLibraryTest01
    ((SFc13_BoatLibraryTest01InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_BoatLibraryTest01();/* state var info */
...
extern void sf_internal_set_sim_state_c13_BoatLibraryTest01(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c13_BoatLibraryTest01((SFc13_BoatLibraryTest01InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_BoatLibraryTest01(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_BoatLibraryTest01(S);
}

static void sf_opaque_set_sim_state_c13_BoatLibraryTest01(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c13_BoatLibraryTest01(S, st);
}

static void sf_opaque_terminate_c13_BoatLibraryTest01(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_BoatLibraryTest01InstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c13_BoatLibraryTest01((SFc13_BoatLibraryTest01InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc13_BoatLibraryTest01((SFc13_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_BoatLibraryTest01(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c13_BoatLibraryTest01
      ((SFc13_BoatLibraryTest01InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c13_BoatLibraryTest01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c13_BoatLibraryTest01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_BoatLibraryTest01(SimStruct *S)
{
  SFc13_BoatLibraryTest01InstanceStruct *chartInstance;
  chartInstance = (SFc13_BoatLibraryTest01InstanceStruct *)utMalloc(sizeof
    (SFc13_BoatLibraryTest01InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_BoatLibraryTest01InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_BoatLibraryTest01;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_BoatLibraryTest01;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_BoatLibraryTest01;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_BoatLibraryTest01;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c13_BoatLibraryTest01;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_BoatLibraryTest01;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_BoatLibraryTest01;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_BoatLibraryTest01;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_BoatLibraryTest01;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_BoatLibraryTest01;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_BoatLibraryTest01;
...
void c13_BoatLibraryTest01_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_BoatLibraryTest01(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_BoatLibraryTest01(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_BoatLibraryTest01(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_BoatLibraryTest01_method_dispatcher.\n"
