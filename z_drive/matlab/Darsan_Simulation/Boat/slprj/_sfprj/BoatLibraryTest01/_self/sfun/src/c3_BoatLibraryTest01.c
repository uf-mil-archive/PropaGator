...
static void initialize_c3_BoatLibraryTest01(SFc3_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void initialize_params_c3_BoatLibraryTest01
  (SFc3_BoatLibraryTest01InstanceStruct *chartInstance);
static void enable_c3_BoatLibraryTest01(SFc3_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void disable_c3_BoatLibraryTest01(SFc3_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_BoatLibraryTest01
  (SFc3_BoatLibraryTest01InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_BoatLibraryTest01
  (SFc3_BoatLibraryTest01InstanceStruct *chartInstance);
static void set_sim_state_c3_BoatLibraryTest01
  (SFc3_BoatLibraryTest01InstanceStruct *chartInstance, const mxArray *c3_st);
static void finalize_c3_BoatLibraryTest01(SFc3_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void sf_c3_BoatLibraryTest01(SFc3_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void c3_chartstep_c3_BoatLibraryTest01
  (SFc3_BoatLibraryTest01InstanceStruct *chartInstance);
static void initSimStructsc3_BoatLibraryTest01
  (SFc3_BoatLibraryTest01InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c3_y, const char_T *c3_identifier, real_T
  c3_b_y[3]);
static void c3_b_emlrt_marshallIn(SFc3_BoatLibraryTest01InstanceStruct
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static void c3_eml_scalar_eg(SFc3_BoatLibraryTest01InstanceStruct *chartInstance);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_BoatLibraryTest01, const
  char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_BoatLibraryTest01InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_BoatLibraryTest01 = 0U;
}
  ...
  (SFc3_BoatLibraryTest01InstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_BoatLibraryTest01;
  ...
  (SFc3_BoatLibraryTest01InstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_BoatLibraryTest01 = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_BoatLibraryTest01");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_BoatLibraryTest01(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_BoatLibraryTest01(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_BoatLibraryTest01InstanceStruct *chartInstance;
  chartInstance = (SFc3_BoatLibraryTest01InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_BoatLibraryTest01_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_BoatLibraryTest01), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_BoatLibraryTest01);
  return c3_y;
}
...
void sf_c3_BoatLibraryTest01_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_BoatLibraryTest01_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_BoatLibraryTest01_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_BoatLibraryTest01_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_BoatLibraryTest01(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c3_BoatLibraryTest01\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_BoatLibraryTest01_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_BoatLibraryTest01InstanceStruct *chartInstance;
    chartInstance = (SFc3_BoatLibraryTest01InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c3_BoatLibraryTest01(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_BoatLibraryTest01((SFc3_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
  initialize_c3_BoatLibraryTest01((SFc3_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_BoatLibraryTest01(void *chartInstanceVar)
{
  enable_c3_BoatLibraryTest01((SFc3_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_BoatLibraryTest01(void *chartInstanceVar)
{
  disable_c3_BoatLibraryTest01((SFc3_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_BoatLibraryTest01(void *chartInstanceVar)
{
  sf_c3_BoatLibraryTest01((SFc3_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_BoatLibraryTest01(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_BoatLibraryTest01
    ((SFc3_BoatLibraryTest01InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_BoatLibraryTest01();/* state var info */
...
extern void sf_internal_set_sim_state_c3_BoatLibraryTest01(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_BoatLibraryTest01((SFc3_BoatLibraryTest01InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_BoatLibraryTest01(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_BoatLibraryTest01(S);
}

static void sf_opaque_set_sim_state_c3_BoatLibraryTest01(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_BoatLibraryTest01(S, st);
}

static void sf_opaque_terminate_c3_BoatLibraryTest01(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_BoatLibraryTest01InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_BoatLibraryTest01_optimization_info();
    }

    finalize_c3_BoatLibraryTest01((SFc3_BoatLibraryTest01InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_BoatLibraryTest01((SFc3_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_BoatLibraryTest01(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_BoatLibraryTest01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_BoatLibraryTest01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_BoatLibraryTest01(SimStruct *S)
{
  SFc3_BoatLibraryTest01InstanceStruct *chartInstance;
  chartInstance = (SFc3_BoatLibraryTest01InstanceStruct *)utMalloc(sizeof
    (SFc3_BoatLibraryTest01InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_BoatLibraryTest01InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_BoatLibraryTest01;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_BoatLibraryTest01;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_BoatLibraryTest01;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_BoatLibraryTest01;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_BoatLibraryTest01;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_BoatLibraryTest01;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_BoatLibraryTest01;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_BoatLibraryTest01;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_BoatLibraryTest01;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_BoatLibraryTest01;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_BoatLibraryTest01;
...
void c3_BoatLibraryTest01_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_BoatLibraryTest01(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_BoatLibraryTest01(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_BoatLibraryTest01(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_BoatLibraryTest01_method_dispatcher.\n"
