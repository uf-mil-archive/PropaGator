...
static void initialize_c8_BoatLibraryTest01(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void initialize_params_c8_BoatLibraryTest01
  (SFc8_BoatLibraryTest01InstanceStruct *chartInstance);
static void enable_c8_BoatLibraryTest01(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void disable_c8_BoatLibraryTest01(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void c8_update_debugger_state_c8_BoatLibraryTest01
  (SFc8_BoatLibraryTest01InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_BoatLibraryTest01
  (SFc8_BoatLibraryTest01InstanceStruct *chartInstance);
static void set_sim_state_c8_BoatLibraryTest01
  (SFc8_BoatLibraryTest01InstanceStruct *chartInstance, const mxArray *c8_st);
static void finalize_c8_BoatLibraryTest01(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void sf_c8_BoatLibraryTest01(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance);
static void c8_chartstep_c8_BoatLibraryTest01
  (SFc8_BoatLibraryTest01InstanceStruct *chartInstance);
static void initSimStructsc8_BoatLibraryTest01
  (SFc8_BoatLibraryTest01InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c8_m, const char_T *c8_identifier);
static real_T c8_b_emlrt_marshallIn(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_c_emlrt_marshallIn(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[3]);
...
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_d_emlrt_marshallIn(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[9]);
...
static real_T c8_cosd(SFc8_BoatLibraryTest01InstanceStruct *chartInstance,
                      real_T c8_x);
static boolean_T c8_isfinite(SFc8_BoatLibraryTest01InstanceStruct *chartInstance,
  real_T c8_x);
static real_T c8_sind(SFc8_BoatLibraryTest01InstanceStruct *chartInstance,
                      real_T c8_x);
static void c8_eml_scalar_eg(SFc8_BoatLibraryTest01InstanceStruct *chartInstance);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_e_emlrt_marshallIn(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_BoatLibraryTest01, const
  char_T *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_cosd(SFc8_BoatLibraryTest01InstanceStruct *chartInstance,
                      real_T *c8_x);
static void c8_b_sind(SFc8_BoatLibraryTest01InstanceStruct *chartInstance,
                      real_T *c8_x);
static void init_dsm_address_info(SFc8_BoatLibraryTest01InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_BoatLibraryTest01 = 0U;
}
  ...
  (SFc8_BoatLibraryTest01InstanceStruct *chartInstance)
{
  ...
  c8_d_hoistedGlobal = chartInstance->c8_is_active_c8_BoatLibraryTest01;
  ...
  (SFc8_BoatLibraryTest01InstanceStruct *chartInstance, const mxArray *c8_st)
{
  ...
  *c8_m = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 2)),
    "m");
  chartInstance->c8_is_active_c8_BoatLibraryTest01 = c8_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 3)),
     "is_active_c8_BoatLibraryTest01");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_BoatLibraryTest01(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_BoatLibraryTest01(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_BoatLibraryTest01InstanceStruct *chartInstance;
  chartInstance = (SFc8_BoatLibraryTest01InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_BoatLibraryTest01_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_BoatLibraryTest01), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_BoatLibraryTest01);
  return c8_y;
}
...
void sf_c8_BoatLibraryTest01_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_BoatLibraryTest01_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_BoatLibraryTest01_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_BoatLibraryTest01_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_BoatLibraryTest01(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"fx\",},{M[1],M[8],T\"fy\",},{M[1],M[9],T\"m\",},{M[8],M[0],T\"is_active_c8_BoatLibraryTest01\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_BoatLibraryTest01_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_BoatLibraryTest01InstanceStruct *chartInstance;
    chartInstance = (SFc8_BoatLibraryTest01InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c8_BoatLibraryTest01(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_BoatLibraryTest01((SFc8_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
  initialize_c8_BoatLibraryTest01((SFc8_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_BoatLibraryTest01(void *chartInstanceVar)
{
  enable_c8_BoatLibraryTest01((SFc8_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_BoatLibraryTest01(void *chartInstanceVar)
{
  disable_c8_BoatLibraryTest01((SFc8_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_BoatLibraryTest01(void *chartInstanceVar)
{
  sf_c8_BoatLibraryTest01((SFc8_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_BoatLibraryTest01(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_BoatLibraryTest01
    ((SFc8_BoatLibraryTest01InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_BoatLibraryTest01();/* state var info */
...
extern void sf_internal_set_sim_state_c8_BoatLibraryTest01(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_BoatLibraryTest01((SFc8_BoatLibraryTest01InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_BoatLibraryTest01(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_BoatLibraryTest01(S);
}

static void sf_opaque_set_sim_state_c8_BoatLibraryTest01(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_BoatLibraryTest01(S, st);
}

static void sf_opaque_terminate_c8_BoatLibraryTest01(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_BoatLibraryTest01InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_BoatLibraryTest01_optimization_info();
    }

    finalize_c8_BoatLibraryTest01((SFc8_BoatLibraryTest01InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_BoatLibraryTest01((SFc8_BoatLibraryTest01InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_BoatLibraryTest01(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_BoatLibraryTest01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_BoatLibraryTest01(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_BoatLibraryTest01(SimStruct *S)
{
  SFc8_BoatLibraryTest01InstanceStruct *chartInstance;
  chartInstance = (SFc8_BoatLibraryTest01InstanceStruct *)utMalloc(sizeof
    (SFc8_BoatLibraryTest01InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_BoatLibraryTest01InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_BoatLibraryTest01;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_BoatLibraryTest01;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_BoatLibraryTest01;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_BoatLibraryTest01;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_BoatLibraryTest01;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_BoatLibraryTest01;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_BoatLibraryTest01;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_BoatLibraryTest01;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_BoatLibraryTest01;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_BoatLibraryTest01;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_BoatLibraryTest01;
...
void c8_BoatLibraryTest01_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_BoatLibraryTest01(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_BoatLibraryTest01(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_BoatLibraryTest01(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_BoatLibraryTest01_method_dispatcher.\n"
