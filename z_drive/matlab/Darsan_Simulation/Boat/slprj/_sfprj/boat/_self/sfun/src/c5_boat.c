...
static void sf_c5_boat(SFc5_boatInstanceStruct *chartInstance)
{
  ...
  sf_debug_symbol_scope_push_eml(0U, 17U, 17U, c5_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml_importable(c5_v1, 16U, c5_sf_marshallOut,
    c5_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1558707797U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2030487211U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2960653127U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4125927805U);
}
...
mxArray *sf_c5_boat_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("zvpRpJLT1e8WcDlBopni1G");
...
static void mdlSetWorkWidths_c5_boat(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(998803835U));
  ssSetChecksum1(S,(3430453789U));
  ssSetChecksum2(S,(1717588731U));
  ssSetChecksum3(S,(1745295450U));
