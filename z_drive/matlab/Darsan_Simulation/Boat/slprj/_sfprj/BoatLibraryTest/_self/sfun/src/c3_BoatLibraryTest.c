...
static void initialize_c3_BoatLibraryTest(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance);
static void initialize_params_c3_BoatLibraryTest
  (SFc3_BoatLibraryTestInstanceStruct *chartInstance);
static void enable_c3_BoatLibraryTest(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance);
static void disable_c3_BoatLibraryTest(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_BoatLibraryTest
  (SFc3_BoatLibraryTestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_BoatLibraryTest
  (SFc3_BoatLibraryTestInstanceStruct *chartInstance);
static void set_sim_state_c3_BoatLibraryTest(SFc3_BoatLibraryTestInstanceStruct *
  chartInstance, const mxArray *c3_st);
static void finalize_c3_BoatLibraryTest(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance);
static void sf_c3_BoatLibraryTest(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance);
static void c3_chartstep_c3_BoatLibraryTest(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance);
static void initSimStructsc3_BoatLibraryTest(SFc3_BoatLibraryTestInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c3_y, const char_T *c3_identifier, real_T
  c3_b_y[3]);
static void c3_b_emlrt_marshallIn(SFc3_BoatLibraryTestInstanceStruct
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static void c3_eml_scalar_eg(SFc3_BoatLibraryTestInstanceStruct *chartInstance);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_BoatLibraryTest, const char_T
  *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_BoatLibraryTestInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_BoatLibraryTest = 0U;
}
  ...
  (SFc3_BoatLibraryTestInstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_BoatLibraryTest;
  ...
  chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_BoatLibraryTest = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_BoatLibraryTest");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_BoatLibraryTest(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_BoatLibraryTest(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_BoatLibraryTestInstanceStruct *chartInstance;
  chartInstance = (SFc3_BoatLibraryTestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_BoatLibraryTest_get_eml_resolved_functions_info(void)
{
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_BoatLibraryTest), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_BoatLibraryTest);
  return c3_y;
}
...
void sf_c3_BoatLibraryTest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_BoatLibraryTest_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_BoatLibraryTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_BoatLibraryTest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_BoatLibraryTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c3_BoatLibraryTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_BoatLibraryTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_BoatLibraryTestInstanceStruct *chartInstance;
    chartInstance = (SFc3_BoatLibraryTestInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c3_BoatLibraryTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_BoatLibraryTestInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_BoatLibraryTest((SFc3_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
  initialize_c3_BoatLibraryTest((SFc3_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_BoatLibraryTest(void *chartInstanceVar)
{
  enable_c3_BoatLibraryTest((SFc3_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_BoatLibraryTest(void *chartInstanceVar)
{
  disable_c3_BoatLibraryTest((SFc3_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_BoatLibraryTest(void *chartInstanceVar)
{
  sf_c3_BoatLibraryTest((SFc3_BoatLibraryTestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_BoatLibraryTest(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_BoatLibraryTest
    ((SFc3_BoatLibraryTestInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_BoatLibraryTest();/* state var info */
...
extern void sf_internal_set_sim_state_c3_BoatLibraryTest(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_BoatLibraryTest((SFc3_BoatLibraryTestInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_BoatLibraryTest(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_BoatLibraryTest(S);
}

static void sf_opaque_set_sim_state_c3_BoatLibraryTest(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_BoatLibraryTest(S, st);
}

static void sf_opaque_terminate_c3_BoatLibraryTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_BoatLibraryTestInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_BoatLibraryTest_optimization_info();
    }

    finalize_c3_BoatLibraryTest((SFc3_BoatLibraryTestInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_BoatLibraryTest((SFc3_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_BoatLibraryTest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_BoatLibraryTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_BoatLibraryTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_BoatLibraryTest(SimStruct *S)
{
  SFc3_BoatLibraryTestInstanceStruct *chartInstance;
  chartInstance = (SFc3_BoatLibraryTestInstanceStruct *)utMalloc(sizeof
    (SFc3_BoatLibraryTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_BoatLibraryTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_BoatLibraryTest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_BoatLibraryTest;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_BoatLibraryTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_BoatLibraryTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_BoatLibraryTest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_BoatLibraryTest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_BoatLibraryTest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_BoatLibraryTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_BoatLibraryTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_BoatLibraryTest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_BoatLibraryTest;
...
void c3_BoatLibraryTest_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_BoatLibraryTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_BoatLibraryTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_BoatLibraryTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_BoatLibraryTest_method_dispatcher.\n"
