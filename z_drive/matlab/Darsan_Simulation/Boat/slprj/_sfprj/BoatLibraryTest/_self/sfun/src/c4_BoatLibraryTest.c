...
static void initialize_c4_BoatLibraryTest(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance);
static void initialize_params_c4_BoatLibraryTest
  (SFc4_BoatLibraryTestInstanceStruct *chartInstance);
static void enable_c4_BoatLibraryTest(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance);
static void disable_c4_BoatLibraryTest(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_BoatLibraryTest
  (SFc4_BoatLibraryTestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_BoatLibraryTest
  (SFc4_BoatLibraryTestInstanceStruct *chartInstance);
static void set_sim_state_c4_BoatLibraryTest(SFc4_BoatLibraryTestInstanceStruct *
  chartInstance, const mxArray *c4_st);
static void finalize_c4_BoatLibraryTest(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance);
static void sf_c4_BoatLibraryTest(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance);
static void c4_chartstep_c4_BoatLibraryTest(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance);
static void initSimStructsc4_BoatLibraryTest(SFc4_BoatLibraryTestInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c4_output, const char_T *c4_identifier, real_T
  c4_y[4]);
static void c4_b_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
...
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_c_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_d_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[20]);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void c4_e_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[7]);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void c4_f_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[8]);
...
static const mxArray *c4_f_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_g_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[5]);
...
static const mxArray *c4_g_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_h_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[4]);
...
static const mxArray *c4_h_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_i_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[2]);
...
static void c4_eml_scalar_eg(SFc4_BoatLibraryTestInstanceStruct *chartInstance);
static void c4_linspace(SFc4_BoatLibraryTestInstanceStruct *chartInstance,
  real_T c4_d1, real_T c4_d2, real_T c4_y[5]);
static void c4_getMinFromGrid(SFc4_BoatLibraryTestInstanceStruct *chartInstance,
  real_T c4_grid[20], real_T c4_preinput[4], real_T c4_Fxref, real_T c4_Fyref,
  real_T c4_Mref, real_T c4_rx1, real_T c4_rx2, real_T c4_ry1, real_T c4_ry2,
  real_T c4_C[7], real_T c4_output[4]);
static real_T c4_costFunction(SFc4_BoatLibraryTestInstanceStruct *chartInstance,
  real_T c4_input[4], real_T c4_preinput[4], real_T c4_Fxref, real_T c4_Fyref,
  real_T c4_Mref, real_T c4_rx1, real_T c4_rx2, real_T c4_ry1, real_T c4_ry2,
  real_T c4_C[7]);
static real_T c4_sind(SFc4_BoatLibraryTestInstanceStruct *chartInstance, real_T
                      c4_x);
static boolean_T c4_isfinite(SFc4_BoatLibraryTestInstanceStruct *chartInstance,
  real_T c4_x);
static real_T c4_cosd(SFc4_BoatLibraryTestInstanceStruct *chartInstance, real_T
                      c4_x);
static real_T c4_mpower(SFc4_BoatLibraryTestInstanceStruct *chartInstance,
  real_T c4_a);
static real_T c4_b_costFunction(SFc4_BoatLibraryTestInstanceStruct
...
static void c4_SteepestDescent(SFc4_BoatLibraryTestInstanceStruct *chartInstance,
  real_T c4_input[4], real_T c4_preinput[4], real_T c4_Fxref, real_T c4_Fyref,
  real_T c4_Mref, real_T c4_rx1, real_T c4_rx2, real_T c4_ry1, real_T c4_ry2,
  real_T c4_C[7], real_T c4_output[4]);
static void c4_Newtons(SFc4_BoatLibraryTestInstanceStruct *chartInstance, real_T
  c4_input[4], real_T c4_Fxref, real_T c4_Fyref, real_T c4_Mref, real_T c4_rx1,
  real_T c4_rx2, real_T c4_ry1, real_T c4_ry2, real_T c4_C[7], real_T c4_output
  [4]);
static const mxArray *c4_i_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_j_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_i_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_k_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_BoatLibraryTest, const char_T
  *c4_identifier);
static uint8_T c4_l_emlrt_marshallIn(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sind(SFc4_BoatLibraryTestInstanceStruct *chartInstance, real_T *
                      c4_x);
static void c4_b_cosd(SFc4_BoatLibraryTestInstanceStruct *chartInstance, real_T *
                      c4_x);
static void init_dsm_address_info(SFc4_BoatLibraryTestInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_BoatLibraryTest = 0U;
}
  ...
  (SFc4_BoatLibraryTestInstanceStruct *chartInstance)
{
  ...
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_BoatLibraryTest;
  ...
  chartInstance, const mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_BoatLibraryTest = c4_k_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
     "is_active_c4_BoatLibraryTest");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_BoatLibraryTest(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_BoatLibraryTest(chartInstance);
  ...
  *chartInstance)
{
  ...
  while (c4_b_k < 100) {
    ...
    CV_EML_FOR(0, 1, 6, 0);
    _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -160);
    _SFD_SYMBOL_SCOPE_POP();
    ...
    while (CV_EML_WHILE(0, 1, 0, c4_v1 < c4_v0)) {
    ...
    exitg1 = FALSE;
    while ((exitg1 == FALSE) && (c4_v1 > c4_v0)) {
      if (c4_b_alpha > 0.0) {
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_BoatLibraryTestInstanceStruct *chartInstance;
  chartInstance = (SFc4_BoatLibraryTestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_BoatLibraryTest_get_eml_resolved_functions_info(void)
{
  ...
  real_T c4_C[7], real_T c4_output[4])
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_output, 22U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 8);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 170U);
  c4_theta1 = c4_input[0];
  ...
  c4_b_dVdtheta1[0] = c4_dVdtheta1;
  c4_b_dVdtheta1[1] = c4_dVdf1;
  c4_b_dVdtheta1[2] = c4_dVdtheta2;
  c4_b_dVdtheta1[3] = c4_dVdf2;
  for (c4_i117 = 0; c4_i117 < 4; c4_i117++) {
    c4_output[c4_i117] = -c4_b_dVdtheta1[c4_i117];
  }

  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -204);
  _SFD_SYMBOL_SCOPE_POP();
}
  ...
  [4])
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_output, 19U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 9);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 212U);
  c4_theta1 = c4_input[0];
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 213U);
  c4_f1 = c4_input[1];
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 214U);
  c4_theta2 = c4_input[2];
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 215U);
  c4_f2 = c4_input[3];
  ...
  c4_ddVddtheta2 = (((((c4_C[6] + c4_rb_y) - c4_gc_y) + c4_ic_y) + c4_kc_y) -
                    c4_pc_y) - c4_uc_y;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 237U);
  c4_vc_a = c4_rx2;
  c4_vc_b = c4_theta2;
  ...
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId)
{
  int32_T c4_y;
  int32_T c4_i118;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), &c4_i118, 1, 6, 0U, 0, 0U, 0);
  c4_y = c4_i118;
  sf_mex_destroy(&c4_u);
  return c4_y;
}
  ...
  *c4_identifier)
{
  ...
  c4_y = c4_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_BoatLibraryTest), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_BoatLibraryTest);
  return c4_y;
}
...
void sf_c4_BoatLibraryTest_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1198048154U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4257055012U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(322392683U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1142217954U);
}

mxArray *sf_c4_BoatLibraryTest_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("JqvDPqs3k0HfLb6PY7k3KH");
...
mxArray *sf_c4_BoatLibraryTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_BoatLibraryTest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_BoatLibraryTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"output\",},{M[8],M[0],T\"is_active_c4_BoatLibraryTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_BoatLibraryTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_BoatLibraryTestInstanceStruct *chartInstance;
    chartInstance = (SFc4_BoatLibraryTestInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML(0,1,10,4,0,0,0,7,2,0,0);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,648);
        _SFD_CV_INIT_EML_FCN(0,1,"getMinFromGrid",650,-1,1366);
        _SFD_CV_INIT_EML_FCN(0,2,"checkInputBound",1368,-1,1536);
        _SFD_CV_INIT_EML_FCN(0,3,"boundGrid",1538,-1,1874);
        _SFD_CV_INIT_EML_FCN(0,4,"sat",1876,-1,2064);
        _SFD_CV_INIT_EML_FCN(0,5,"getStepSize",2066,-1,2838);
        _SFD_CV_INIT_EML_FCN(0,6,"costFunction",2840,-1,3573);
        _SFD_CV_INIT_EML_FCN(0,7,"getDirection",3575,-1,3990);
        _SFD_CV_INIT_EML_FCN(0,8,"SteepestDescent",3992,-1,5668);
        _SFD_CV_INIT_EML_FCN(0,9,"Newtons",5670,-1,7071);
        _SFD_CV_INIT_EML_IF(0,1,0,1157,1167,1249,1321);
        _SFD_CV_INIT_EML_IF(0,1,1,1917,1936,1968,2059);
        _SFD_CV_INIT_EML_IF(0,1,2,1968,1991,2023,2059);
        _SFD_CV_INIT_EML_IF(0,1,3,3871,3889,3930,3978);
        _SFD_CV_INIT_EML_FOR(0,1,0,368,382,621);
        _SFD_CV_INIT_EML_FOR(0,1,1,904,917,1361);
        _SFD_CV_INIT_EML_FOR(0,1,2,921,934,1357);
        _SFD_CV_INIT_EML_FOR(0,1,3,942,955,1349);
        _SFD_CV_INIT_EML_FOR(0,1,4,967,980,1337);
        _SFD_CV_INIT_EML_FOR(0,1,5,1439,1463,1516);
        _SFD_CV_INIT_EML_FOR(0,1,6,3841,3862,3986);
        _SFD_CV_INIT_EML_WHILE(0,1,0,2428,2442,2609);
        _SFD_CV_INIT_EML_WHILE(0,1,1,2615,2642,2812);
...
{
  return "UHokd3DikTW0BTsytXacFB";
}

static void sf_opaque_initialize_c4_BoatLibraryTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_BoatLibraryTestInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_BoatLibraryTest((SFc4_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
  initialize_c4_BoatLibraryTest((SFc4_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_BoatLibraryTest(void *chartInstanceVar)
{
  enable_c4_BoatLibraryTest((SFc4_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_BoatLibraryTest(void *chartInstanceVar)
{
  disable_c4_BoatLibraryTest((SFc4_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_BoatLibraryTest(void *chartInstanceVar)
{
  sf_c4_BoatLibraryTest((SFc4_BoatLibraryTestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_BoatLibraryTest(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_BoatLibraryTest
    ((SFc4_BoatLibraryTestInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_BoatLibraryTest();/* state var info */
...
extern void sf_internal_set_sim_state_c4_BoatLibraryTest(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_BoatLibraryTest((SFc4_BoatLibraryTestInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_BoatLibraryTest(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_BoatLibraryTest(S);
}

static void sf_opaque_set_sim_state_c4_BoatLibraryTest(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_BoatLibraryTest(S, st);
}

static void sf_opaque_terminate_c4_BoatLibraryTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_BoatLibraryTestInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_BoatLibraryTest_optimization_info();
    }

    finalize_c4_BoatLibraryTest((SFc4_BoatLibraryTestInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_BoatLibraryTest((SFc4_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_BoatLibraryTest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_BoatLibraryTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2977317734U));
  ssSetChecksum1(S,(2829950533U));
  ssSetChecksum2(S,(2147059532U));
  ssSetChecksum3(S,(1399211583U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_BoatLibraryTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_BoatLibraryTest(SimStruct *S)
{
  SFc4_BoatLibraryTestInstanceStruct *chartInstance;
  chartInstance = (SFc4_BoatLibraryTestInstanceStruct *)utMalloc(sizeof
    (SFc4_BoatLibraryTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_BoatLibraryTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_BoatLibraryTest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_BoatLibraryTest;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_BoatLibraryTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_BoatLibraryTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_BoatLibraryTest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_BoatLibraryTest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_BoatLibraryTest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_BoatLibraryTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_BoatLibraryTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_BoatLibraryTest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_BoatLibraryTest;
...
void c4_BoatLibraryTest_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_BoatLibraryTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_BoatLibraryTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_BoatLibraryTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_BoatLibraryTest_method_dispatcher.\n"
