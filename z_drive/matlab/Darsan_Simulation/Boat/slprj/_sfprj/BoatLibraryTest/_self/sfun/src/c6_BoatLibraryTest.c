...
static void initialize_c6_BoatLibraryTest(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance);
static void initialize_params_c6_BoatLibraryTest
  (SFc6_BoatLibraryTestInstanceStruct *chartInstance);
static void enable_c6_BoatLibraryTest(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance);
static void disable_c6_BoatLibraryTest(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance);
static void c6_update_debugger_state_c6_BoatLibraryTest
  (SFc6_BoatLibraryTestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_BoatLibraryTest
  (SFc6_BoatLibraryTestInstanceStruct *chartInstance);
static void set_sim_state_c6_BoatLibraryTest(SFc6_BoatLibraryTestInstanceStruct *
  chartInstance, const mxArray *c6_st);
static void finalize_c6_BoatLibraryTest(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance);
static void sf_c6_BoatLibraryTest(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance);
static void c6_chartstep_c6_BoatLibraryTest(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance);
static void initSimStructsc6_BoatLibraryTest(SFc6_BoatLibraryTestInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c6_y, const char_T *c6_identifier, real_T
  c6_b_y[3]);
static void c6_b_emlrt_marshallIn(SFc6_BoatLibraryTestInstanceStruct
...
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
...
static void c6_eml_scalar_eg(SFc6_BoatLibraryTestInstanceStruct *chartInstance);
static const mxArray *c6_e_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_d_emlrt_marshallIn(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_e_emlrt_marshallIn(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_BoatLibraryTest, const char_T
  *c6_identifier);
static uint8_T c6_f_emlrt_marshallIn(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_BoatLibraryTestInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_BoatLibraryTest = 0U;
}
  ...
  (SFc6_BoatLibraryTestInstanceStruct *chartInstance)
{
  ...
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_BoatLibraryTest;
  ...
  chartInstance, const mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_BoatLibraryTest = c6_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
     "is_active_c6_BoatLibraryTest");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_BoatLibraryTest(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_BoatLibraryTest(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_BoatLibraryTestInstanceStruct *chartInstance;
  chartInstance = (SFc6_BoatLibraryTestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_BoatLibraryTest_get_eml_resolved_functions_info(void)
{
  ...
  *c6_identifier)
{
  ...
  c6_y = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_BoatLibraryTest), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_BoatLibraryTest);
  return c6_y;
}
...
void sf_c6_BoatLibraryTest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_BoatLibraryTest_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_BoatLibraryTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_BoatLibraryTest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_BoatLibraryTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c6_BoatLibraryTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_BoatLibraryTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_BoatLibraryTestInstanceStruct *chartInstance;
    chartInstance = (SFc6_BoatLibraryTestInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c6_BoatLibraryTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_BoatLibraryTestInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_BoatLibraryTest((SFc6_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
  initialize_c6_BoatLibraryTest((SFc6_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_BoatLibraryTest(void *chartInstanceVar)
{
  enable_c6_BoatLibraryTest((SFc6_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c6_BoatLibraryTest(void *chartInstanceVar)
{
  disable_c6_BoatLibraryTest((SFc6_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_BoatLibraryTest(void *chartInstanceVar)
{
  sf_c6_BoatLibraryTest((SFc6_BoatLibraryTestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_BoatLibraryTest(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_BoatLibraryTest
    ((SFc6_BoatLibraryTestInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_BoatLibraryTest();/* state var info */
...
extern void sf_internal_set_sim_state_c6_BoatLibraryTest(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c6_BoatLibraryTest((SFc6_BoatLibraryTestInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_BoatLibraryTest(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_BoatLibraryTest(S);
}

static void sf_opaque_set_sim_state_c6_BoatLibraryTest(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c6_BoatLibraryTest(S, st);
}

static void sf_opaque_terminate_c6_BoatLibraryTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_BoatLibraryTestInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_BoatLibraryTest_optimization_info();
    }

    finalize_c6_BoatLibraryTest((SFc6_BoatLibraryTestInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc6_BoatLibraryTest((SFc6_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_BoatLibraryTest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_BoatLibraryTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_BoatLibraryTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_BoatLibraryTest(SimStruct *S)
{
  SFc6_BoatLibraryTestInstanceStruct *chartInstance;
  chartInstance = (SFc6_BoatLibraryTestInstanceStruct *)utMalloc(sizeof
    (SFc6_BoatLibraryTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_BoatLibraryTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_BoatLibraryTest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_BoatLibraryTest;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_BoatLibraryTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_BoatLibraryTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_BoatLibraryTest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_BoatLibraryTest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_BoatLibraryTest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_BoatLibraryTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_BoatLibraryTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_BoatLibraryTest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_BoatLibraryTest;
...
void c6_BoatLibraryTest_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_BoatLibraryTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_BoatLibraryTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_BoatLibraryTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_BoatLibraryTest_method_dispatcher.\n"
