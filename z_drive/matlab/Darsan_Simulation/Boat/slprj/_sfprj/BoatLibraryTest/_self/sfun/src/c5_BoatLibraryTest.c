...
static void initialize_c5_BoatLibraryTest(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance);
static void initialize_params_c5_BoatLibraryTest
  (SFc5_BoatLibraryTestInstanceStruct *chartInstance);
static void enable_c5_BoatLibraryTest(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance);
static void disable_c5_BoatLibraryTest(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance);
static void c5_update_debugger_state_c5_BoatLibraryTest
  (SFc5_BoatLibraryTestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_BoatLibraryTest
  (SFc5_BoatLibraryTestInstanceStruct *chartInstance);
static void set_sim_state_c5_BoatLibraryTest(SFc5_BoatLibraryTestInstanceStruct *
  chartInstance, const mxArray *c5_st);
static void finalize_c5_BoatLibraryTest(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance);
static void sf_c5_BoatLibraryTest(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance);
static void c5_chartstep_c5_BoatLibraryTest(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance);
static void initSimStructsc5_BoatLibraryTest(SFc5_BoatLibraryTestInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static void c5_emlrt_marshallIn(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c5_v1, const char_T *c5_identifier, real_T
  c5_y[6]);
static void c5_b_emlrt_marshallIn(SFc5_BoatLibraryTestInstanceStruct
...
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static real_T c5_sind(SFc5_BoatLibraryTestInstanceStruct *chartInstance, real_T
                      c5_x);
static boolean_T c5_isfinite(SFc5_BoatLibraryTestInstanceStruct *chartInstance,
  real_T c5_x);
static real_T c5_cosd(SFc5_BoatLibraryTestInstanceStruct *chartInstance, real_T
                      c5_x);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_d_emlrt_marshallIn(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_e_emlrt_marshallIn(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_BoatLibraryTest, const char_T
  *c5_identifier);
static uint8_T c5_f_emlrt_marshallIn(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sind(SFc5_BoatLibraryTestInstanceStruct *chartInstance, real_T *
                      c5_x);
static void c5_b_cosd(SFc5_BoatLibraryTestInstanceStruct *chartInstance, real_T *
                      c5_x);
static void init_dsm_address_info(SFc5_BoatLibraryTestInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_BoatLibraryTest = 0U;
}
  ...
  (SFc5_BoatLibraryTestInstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal = chartInstance->c5_is_active_c5_BoatLibraryTest;
  ...
  chartInstance, const mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_BoatLibraryTest = c5_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
     "is_active_c5_BoatLibraryTest");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_BoatLibraryTest(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_BoatLibraryTest(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_BoatLibraryTestInstanceStruct *chartInstance;
  chartInstance = (SFc5_BoatLibraryTestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_BoatLibraryTest_get_eml_resolved_functions_info(void)
{
  ...
  *c5_identifier)
{
  ...
  c5_y = c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_BoatLibraryTest), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_BoatLibraryTest);
  return c5_y;
}
...
void sf_c5_BoatLibraryTest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_BoatLibraryTest_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_BoatLibraryTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_BoatLibraryTest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_BoatLibraryTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"v1\",},{M[8],M[0],T\"is_active_c5_BoatLibraryTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_BoatLibraryTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_BoatLibraryTestInstanceStruct *chartInstance;
    chartInstance = (SFc5_BoatLibraryTestInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c5_BoatLibraryTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_BoatLibraryTestInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_BoatLibraryTest((SFc5_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
  initialize_c5_BoatLibraryTest((SFc5_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c5_BoatLibraryTest(void *chartInstanceVar)
{
  enable_c5_BoatLibraryTest((SFc5_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c5_BoatLibraryTest(void *chartInstanceVar)
{
  disable_c5_BoatLibraryTest((SFc5_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_BoatLibraryTest(void *chartInstanceVar)
{
  sf_c5_BoatLibraryTest((SFc5_BoatLibraryTestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_BoatLibraryTest(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_BoatLibraryTest
    ((SFc5_BoatLibraryTestInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_BoatLibraryTest();/* state var info */
...
extern void sf_internal_set_sim_state_c5_BoatLibraryTest(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_BoatLibraryTest((SFc5_BoatLibraryTestInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_BoatLibraryTest(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_BoatLibraryTest(S);
}

static void sf_opaque_set_sim_state_c5_BoatLibraryTest(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c5_BoatLibraryTest(S, st);
}

static void sf_opaque_terminate_c5_BoatLibraryTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_BoatLibraryTestInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_BoatLibraryTest_optimization_info();
    }

    finalize_c5_BoatLibraryTest((SFc5_BoatLibraryTestInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc5_BoatLibraryTest((SFc5_BoatLibraryTestInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_BoatLibraryTest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_BoatLibraryTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_BoatLibraryTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_BoatLibraryTest(SimStruct *S)
{
  SFc5_BoatLibraryTestInstanceStruct *chartInstance;
  chartInstance = (SFc5_BoatLibraryTestInstanceStruct *)utMalloc(sizeof
    (SFc5_BoatLibraryTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_BoatLibraryTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_BoatLibraryTest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_BoatLibraryTest;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_BoatLibraryTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_BoatLibraryTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_BoatLibraryTest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_BoatLibraryTest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_BoatLibraryTest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_BoatLibraryTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_BoatLibraryTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_BoatLibraryTest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_BoatLibraryTest;
...
void c5_BoatLibraryTest_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_BoatLibraryTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_BoatLibraryTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_BoatLibraryTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_BoatLibraryTest_method_dispatcher.\n"
