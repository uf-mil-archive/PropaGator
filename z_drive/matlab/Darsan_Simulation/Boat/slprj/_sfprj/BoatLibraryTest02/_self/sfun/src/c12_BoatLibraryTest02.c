...
static void initialize_c12_BoatLibraryTest02
  (SFc12_BoatLibraryTest02InstanceStruct *chartInstance);
static void initialize_params_c12_BoatLibraryTest02
  (SFc12_BoatLibraryTest02InstanceStruct *chartInstance);
static void enable_c12_BoatLibraryTest02(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void disable_c12_BoatLibraryTest02(SFc12_BoatLibraryTest02InstanceStruct *
  chartInstance);
static void c12_update_debugger_state_c12_BoatLibraryTest02
  (SFc12_BoatLibraryTest02InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_BoatLibraryTest02
  (SFc12_BoatLibraryTest02InstanceStruct *chartInstance);
static void set_sim_state_c12_BoatLibraryTest02
  (SFc12_BoatLibraryTest02InstanceStruct *chartInstance, const mxArray *c12_st);
static void finalize_c12_BoatLibraryTest02(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void sf_c12_BoatLibraryTest02(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void c12_chartstep_c12_BoatLibraryTest02
  (SFc12_BoatLibraryTest02InstanceStruct *chartInstance);
static void initSimStructsc12_BoatLibraryTest02
  (SFc12_BoatLibraryTest02InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_emlrt_marshallIn(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c12_m, const char_T *c12_identifier);
static real_T c12_b_emlrt_marshallIn(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_b_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_c_emlrt_marshallIn(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[3]);
...
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_d_emlrt_marshallIn(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[9]);
...
static real_T c12_cosd(SFc12_BoatLibraryTest02InstanceStruct *chartInstance,
  real_T c12_x);
static boolean_T c12_isfinite(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance, real_T c12_x);
static real_T c12_sind(SFc12_BoatLibraryTest02InstanceStruct *chartInstance,
  real_T c12_x);
static void c12_eml_scalar_eg(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance);
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_e_emlrt_marshallIn(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_f_emlrt_marshallIn(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c12_b_is_active_c12_BoatLibraryTest02, const
  char_T *c12_identifier);
static uint8_T c12_g_emlrt_marshallIn(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_b_cosd(SFc12_BoatLibraryTest02InstanceStruct *chartInstance,
  real_T *c12_x);
static void c12_b_sind(SFc12_BoatLibraryTest02InstanceStruct *chartInstance,
  real_T *c12_x);
static void init_dsm_address_info(SFc12_BoatLibraryTest02InstanceStruct
  *chartInstance);
  ...
  (SFc12_BoatLibraryTest02InstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_BoatLibraryTest02 = 0U;
}
  ...
  (SFc12_BoatLibraryTest02InstanceStruct *chartInstance)
{
  ...
  c12_d_hoistedGlobal = chartInstance->c12_is_active_c12_BoatLibraryTest02;
  ...
  (SFc12_BoatLibraryTest02InstanceStruct *chartInstance, const mxArray *c12_st)
{
  ...
  *c12_m = c12_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c12_u,
    2)), "m");
  chartInstance->c12_is_active_c12_BoatLibraryTest02 = c12_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 3)),
     "is_active_c12_BoatLibraryTest02");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_BoatLibraryTest02(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c12_sfEvent = CALL_EVENT;
  c12_chartstep_c12_BoatLibraryTest02(chartInstance);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_BoatLibraryTest02InstanceStruct *chartInstance;
  chartInstance = (SFc12_BoatLibraryTest02InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c12_BoatLibraryTest02_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c12_identifier)
{
  ...
  c12_y = c12_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_BoatLibraryTest02), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_BoatLibraryTest02);
  return c12_y;
}
...
void sf_c12_BoatLibraryTest02_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c12_BoatLibraryTest02_get_autoinheritance_info(void)
{
...
mxArray *sf_c12_BoatLibraryTest02_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_BoatLibraryTest02_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c12_BoatLibraryTest02(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"fx\",},{M[1],M[8],T\"fy\",},{M[1],M[9],T\"m\",},{M[8],M[0],T\"is_active_c12_BoatLibraryTest02\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_BoatLibraryTest02_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc12_BoatLibraryTest02InstanceStruct *chartInstance;
    chartInstance = (SFc12_BoatLibraryTest02InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c12_BoatLibraryTest02(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_BoatLibraryTest02((SFc12_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
  initialize_c12_BoatLibraryTest02((SFc12_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c12_BoatLibraryTest02(void *chartInstanceVar)
{
  enable_c12_BoatLibraryTest02((SFc12_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c12_BoatLibraryTest02(void *chartInstanceVar)
{
  disable_c12_BoatLibraryTest02((SFc12_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c12_BoatLibraryTest02(void *chartInstanceVar)
{
  sf_c12_BoatLibraryTest02((SFc12_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c12_BoatLibraryTest02(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_BoatLibraryTest02
    ((SFc12_BoatLibraryTest02InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_BoatLibraryTest02();/* state var info */
...
extern void sf_internal_set_sim_state_c12_BoatLibraryTest02(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c12_BoatLibraryTest02((SFc12_BoatLibraryTest02InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c12_BoatLibraryTest02(SimStruct* S)
{
  return sf_internal_get_sim_state_c12_BoatLibraryTest02(S);
}

static void sf_opaque_set_sim_state_c12_BoatLibraryTest02(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c12_BoatLibraryTest02(S, st);
}

static void sf_opaque_terminate_c12_BoatLibraryTest02(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_BoatLibraryTest02InstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c12_BoatLibraryTest02((SFc12_BoatLibraryTest02InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc12_BoatLibraryTest02((SFc12_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_BoatLibraryTest02(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c12_BoatLibraryTest02
      ((SFc12_BoatLibraryTest02InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c12_BoatLibraryTest02(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c12_BoatLibraryTest02(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_BoatLibraryTest02(SimStruct *S)
{
  SFc12_BoatLibraryTest02InstanceStruct *chartInstance;
  chartInstance = (SFc12_BoatLibraryTest02InstanceStruct *)utMalloc(sizeof
    (SFc12_BoatLibraryTest02InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_BoatLibraryTest02InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_BoatLibraryTest02;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_BoatLibraryTest02;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_BoatLibraryTest02;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_BoatLibraryTest02;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_BoatLibraryTest02;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_BoatLibraryTest02;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_BoatLibraryTest02;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_BoatLibraryTest02;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_BoatLibraryTest02;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_BoatLibraryTest02;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_BoatLibraryTest02;
...
void c12_BoatLibraryTest02_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_BoatLibraryTest02(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_BoatLibraryTest02(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_BoatLibraryTest02(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_BoatLibraryTest02_method_dispatcher.\n"
