...
static void initialize_c2_BoatLibraryTest02(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void initialize_params_c2_BoatLibraryTest02
  (SFc2_BoatLibraryTest02InstanceStruct *chartInstance);
static void enable_c2_BoatLibraryTest02(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void disable_c2_BoatLibraryTest02(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_BoatLibraryTest02
  (SFc2_BoatLibraryTest02InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_BoatLibraryTest02
  (SFc2_BoatLibraryTest02InstanceStruct *chartInstance);
static void set_sim_state_c2_BoatLibraryTest02
  (SFc2_BoatLibraryTest02InstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_BoatLibraryTest02(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void sf_c2_BoatLibraryTest02(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void c2_chartstep_c2_BoatLibraryTest02
  (SFc2_BoatLibraryTest02InstanceStruct *chartInstance);
static void initSimStructsc2_BoatLibraryTest02
  (SFc2_BoatLibraryTest02InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c2_y, const char_T *c2_identifier, real_T
  c2_b_y[3]);
static void c2_b_emlrt_marshallIn(SFc2_BoatLibraryTest02InstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c2_x, const char_T *c2_identifier, real_T c2_y
  [6]);
static void c2_d_emlrt_marshallIn(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[6]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_e_emlrt_marshallIn(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static void c2_eml_scalar_eg(SFc2_BoatLibraryTest02InstanceStruct *chartInstance);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_BoatLibraryTest02, const
  char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_BoatLibraryTest02InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_BoatLibraryTest02 = 0U;
}
  ...
  (SFc2_BoatLibraryTest02InstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_BoatLibraryTest02;
  ...
  (SFc2_BoatLibraryTest02InstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_BoatLibraryTest02 = c2_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_BoatLibraryTest02");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_BoatLibraryTest02(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_BoatLibraryTest02(chartInstance);
  ...
  (SFc2_BoatLibraryTest02InstanceStruct *chartInstance)
{
  ...
  c2_q_y = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 2);
  ...
  for (c2_i18 = 0; c2_i18 < 3; c2_i18++) {
    ...
    for (c2_i20 = 0; c2_i20 < 6; c2_i20++) {
      c2_y[c2_i18] += c2_g_a[c2_i19 + c2_i18] * c2_d_b[c2_i20];
      c2_i19 += 3;
    }
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_BoatLibraryTest02InstanceStruct *chartInstance;
  chartInstance = (SFc2_BoatLibraryTest02InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_BoatLibraryTest02_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_BoatLibraryTest02), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_BoatLibraryTest02);
  return c2_y;
}
...
void sf_c2_BoatLibraryTest02_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1572713106U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(37567663U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1071294783U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3465284822U);
}

mxArray *sf_c2_BoatLibraryTest02_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("0LeYC0X72T9fIz2xt4ikMH");
...
mxArray *sf_c2_BoatLibraryTest02_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_BoatLibraryTest02_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_BoatLibraryTest02(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[11],T\"x\",},{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_BoatLibraryTest02\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_BoatLibraryTest02_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_BoatLibraryTest02InstanceStruct *chartInstance;
    chartInstance = (SFc2_BoatLibraryTest02InstanceStruct *) ((ChartInfoStruct *)
...
{
  return "0mJVB7xWVJDFfL53Pc5S1D";
}

static void sf_opaque_initialize_c2_BoatLibraryTest02(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_BoatLibraryTest02((SFc2_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
  initialize_c2_BoatLibraryTest02((SFc2_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_BoatLibraryTest02(void *chartInstanceVar)
{
  enable_c2_BoatLibraryTest02((SFc2_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_BoatLibraryTest02(void *chartInstanceVar)
{
  disable_c2_BoatLibraryTest02((SFc2_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_BoatLibraryTest02(void *chartInstanceVar)
{
  sf_c2_BoatLibraryTest02((SFc2_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_BoatLibraryTest02(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_BoatLibraryTest02
    ((SFc2_BoatLibraryTest02InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_BoatLibraryTest02();/* state var info */
...
extern void sf_internal_set_sim_state_c2_BoatLibraryTest02(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_BoatLibraryTest02((SFc2_BoatLibraryTest02InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_BoatLibraryTest02(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_BoatLibraryTest02(S);
}

static void sf_opaque_set_sim_state_c2_BoatLibraryTest02(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_BoatLibraryTest02(S, st);
}

static void sf_opaque_terminate_c2_BoatLibraryTest02(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_BoatLibraryTest02InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_BoatLibraryTest02_optimization_info();
    }

    finalize_c2_BoatLibraryTest02((SFc2_BoatLibraryTest02InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_BoatLibraryTest02((SFc2_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_BoatLibraryTest02(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_BoatLibraryTest02(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2398358987U));
  ssSetChecksum1(S,(1178258108U));
  ssSetChecksum2(S,(2151687350U));
  ssSetChecksum3(S,(990295792U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_BoatLibraryTest02(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_BoatLibraryTest02(SimStruct *S)
{
  SFc2_BoatLibraryTest02InstanceStruct *chartInstance;
  chartInstance = (SFc2_BoatLibraryTest02InstanceStruct *)utMalloc(sizeof
    (SFc2_BoatLibraryTest02InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_BoatLibraryTest02InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_BoatLibraryTest02;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_BoatLibraryTest02;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_BoatLibraryTest02;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_BoatLibraryTest02;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_BoatLibraryTest02;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_BoatLibraryTest02;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_BoatLibraryTest02;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_BoatLibraryTest02;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_BoatLibraryTest02;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_BoatLibraryTest02;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_BoatLibraryTest02;
...
void c2_BoatLibraryTest02_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_BoatLibraryTest02(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_BoatLibraryTest02(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_BoatLibraryTest02(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_BoatLibraryTest02_method_dispatcher.\n"
