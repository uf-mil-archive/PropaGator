...
static void initialize_c1_BoatLibraryTest02(SFc1_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void initialize_params_c1_BoatLibraryTest02
  (SFc1_BoatLibraryTest02InstanceStruct *chartInstance);
static void enable_c1_BoatLibraryTest02(SFc1_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void disable_c1_BoatLibraryTest02(SFc1_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_BoatLibraryTest02
  (SFc1_BoatLibraryTest02InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_BoatLibraryTest02
  (SFc1_BoatLibraryTest02InstanceStruct *chartInstance);
static void set_sim_state_c1_BoatLibraryTest02
  (SFc1_BoatLibraryTest02InstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_BoatLibraryTest02(SFc1_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void sf_c1_BoatLibraryTest02(SFc1_BoatLibraryTest02InstanceStruct
  *chartInstance);
static void c1_chartstep_c1_BoatLibraryTest02
  (SFc1_BoatLibraryTest02InstanceStruct *chartInstance);
static void initSimStructsc1_BoatLibraryTest02
  (SFc1_BoatLibraryTest02InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c1_v1, const char_T *c1_identifier, real_T
  c1_y[6]);
static void c1_b_emlrt_marshallIn(SFc1_BoatLibraryTest02InstanceStruct
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static real_T c1_sind(SFc1_BoatLibraryTest02InstanceStruct *chartInstance,
                      real_T c1_x);
static boolean_T c1_isfinite(SFc1_BoatLibraryTest02InstanceStruct *chartInstance,
  real_T c1_x);
static real_T c1_cosd(SFc1_BoatLibraryTest02InstanceStruct *chartInstance,
                      real_T c1_x);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_BoatLibraryTest02, const
  char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_BoatLibraryTest02InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sind(SFc1_BoatLibraryTest02InstanceStruct *chartInstance,
                      real_T *c1_x);
static void c1_b_cosd(SFc1_BoatLibraryTest02InstanceStruct *chartInstance,
                      real_T *c1_x);
static void init_dsm_address_info(SFc1_BoatLibraryTest02InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_BoatLibraryTest02 = 0U;
}
  ...
  (SFc1_BoatLibraryTest02InstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_BoatLibraryTest02;
  ...
  (SFc1_BoatLibraryTest02InstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_BoatLibraryTest02 = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_BoatLibraryTest02");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_BoatLibraryTest02(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_BoatLibraryTest02(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_BoatLibraryTest02InstanceStruct *chartInstance;
  chartInstance = (SFc1_BoatLibraryTest02InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_BoatLibraryTest02_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_BoatLibraryTest02), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_BoatLibraryTest02);
  return c1_y;
}
...
void sf_c1_BoatLibraryTest02_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_BoatLibraryTest02_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_BoatLibraryTest02_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_BoatLibraryTest02_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_BoatLibraryTest02(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"v1\",},{M[8],M[0],T\"is_active_c1_BoatLibraryTest02\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_BoatLibraryTest02_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_BoatLibraryTest02InstanceStruct *chartInstance;
    chartInstance = (SFc1_BoatLibraryTest02InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_BoatLibraryTest02(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_BoatLibraryTest02((SFc1_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
  initialize_c1_BoatLibraryTest02((SFc1_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_BoatLibraryTest02(void *chartInstanceVar)
{
  enable_c1_BoatLibraryTest02((SFc1_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_BoatLibraryTest02(void *chartInstanceVar)
{
  disable_c1_BoatLibraryTest02((SFc1_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_BoatLibraryTest02(void *chartInstanceVar)
{
  sf_c1_BoatLibraryTest02((SFc1_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_BoatLibraryTest02(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_BoatLibraryTest02
    ((SFc1_BoatLibraryTest02InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_BoatLibraryTest02();/* state var info */
...
extern void sf_internal_set_sim_state_c1_BoatLibraryTest02(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_BoatLibraryTest02((SFc1_BoatLibraryTest02InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_BoatLibraryTest02(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_BoatLibraryTest02(S);
}

static void sf_opaque_set_sim_state_c1_BoatLibraryTest02(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_BoatLibraryTest02(S, st);
}

static void sf_opaque_terminate_c1_BoatLibraryTest02(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_BoatLibraryTest02InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_BoatLibraryTest02_optimization_info();
    }

    finalize_c1_BoatLibraryTest02((SFc1_BoatLibraryTest02InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_BoatLibraryTest02((SFc1_BoatLibraryTest02InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_BoatLibraryTest02(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_BoatLibraryTest02(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_BoatLibraryTest02(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_BoatLibraryTest02(SimStruct *S)
{
  SFc1_BoatLibraryTest02InstanceStruct *chartInstance;
  chartInstance = (SFc1_BoatLibraryTest02InstanceStruct *)utMalloc(sizeof
    (SFc1_BoatLibraryTest02InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_BoatLibraryTest02InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_BoatLibraryTest02;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_BoatLibraryTest02;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_BoatLibraryTest02;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_BoatLibraryTest02;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_BoatLibraryTest02;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_BoatLibraryTest02;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_BoatLibraryTest02;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_BoatLibraryTest02;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_BoatLibraryTest02;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_BoatLibraryTest02;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_BoatLibraryTest02;
...
void c1_BoatLibraryTest02_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_BoatLibraryTest02(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_BoatLibraryTest02(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_BoatLibraryTest02(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_BoatLibraryTest02_method_dispatcher.\n"
