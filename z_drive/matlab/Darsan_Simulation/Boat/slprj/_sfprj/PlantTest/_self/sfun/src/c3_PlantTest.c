...
static void initialize_c3_PlantTest(SFc3_PlantTestInstanceStruct *chartInstance);
static void initialize_params_c3_PlantTest(SFc3_PlantTestInstanceStruct
  *chartInstance);
static void enable_c3_PlantTest(SFc3_PlantTestInstanceStruct *chartInstance);
static void disable_c3_PlantTest(SFc3_PlantTestInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_PlantTest(SFc3_PlantTestInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_PlantTest(SFc3_PlantTestInstanceStruct
  *chartInstance);
static void set_sim_state_c3_PlantTest(SFc3_PlantTestInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_PlantTest(SFc3_PlantTestInstanceStruct *chartInstance);
static void sf_c3_PlantTest(SFc3_PlantTestInstanceStruct *chartInstance);
static void c3_chartstep_c3_PlantTest(SFc3_PlantTestInstanceStruct
  *chartInstance);
static void initSimStructsc3_PlantTest(SFc3_PlantTestInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_PlantTestInstanceStruct *chartInstance,
  const mxArray *c3_y, const char_T *c3_identifier, real_T c3_b_y[3]);
static void c3_b_emlrt_marshallIn(SFc3_PlantTestInstanceStruct *chartInstance,
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_PlantTestInstanceStruct *chartInstance,
...
static void c3_eml_scalar_eg(SFc3_PlantTestInstanceStruct *chartInstance);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_PlantTestInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_PlantTestInstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_PlantTest, const char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_PlantTestInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_PlantTestInstanceStruct *chartInstance);
...
static void initialize_c3_PlantTest(SFc3_PlantTestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_PlantTest = 0U;
}
  ...
  *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_PlantTest;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_PlantTest = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 1)), "is_active_c3_PlantTest");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_PlantTest(chartInstance);
...
static void sf_c3_PlantTest(SFc3_PlantTestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_PlantTest(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u[3];
  const mxArray *c3_y = NULL;
  SFc3_PlantTestInstanceStruct *chartInstance;
  chartInstance = (SFc3_PlantTestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_PlantTest_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c3_b_is_active_c3_PlantTest, const char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_PlantTest), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_PlantTest);
  return c3_y;
}
...
void sf_c3_PlantTest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_PlantTest_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_PlantTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_PlantTest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_PlantTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c3_PlantTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_PlantTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_PlantTestInstanceStruct *chartInstance;
    chartInstance = (SFc3_PlantTestInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c3_PlantTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_PlantTestInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c3_PlantTest((SFc3_PlantTestInstanceStruct*)
    chartInstanceVar);
  initialize_c3_PlantTest((SFc3_PlantTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_PlantTest(void *chartInstanceVar)
{
  enable_c3_PlantTest((SFc3_PlantTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_PlantTest(void *chartInstanceVar)
{
  disable_c3_PlantTest((SFc3_PlantTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_PlantTest(void *chartInstanceVar)
{
  sf_c3_PlantTest((SFc3_PlantTestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_PlantTest(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_PlantTest((SFc3_PlantTestInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_PlantTest();/* state var info */
...
extern void sf_internal_set_sim_state_c3_PlantTest(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_PlantTest((SFc3_PlantTestInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_PlantTest(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_PlantTest(S);
}

static void sf_opaque_set_sim_state_c3_PlantTest(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_PlantTest(S, st);
}

static void sf_opaque_terminate_c3_PlantTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_PlantTestInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_PlantTest_optimization_info();
    }

    finalize_c3_PlantTest((SFc3_PlantTestInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_PlantTest((SFc3_PlantTestInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_PlantTest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_PlantTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_PlantTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_PlantTest(SimStruct *S)
{
  SFc3_PlantTestInstanceStruct *chartInstance;
  chartInstance = (SFc3_PlantTestInstanceStruct *)utMalloc(sizeof
    (SFc3_PlantTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_PlantTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_PlantTest;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_PlantTest;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_PlantTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_PlantTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_PlantTest;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_PlantTest;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_PlantTest;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_PlantTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_PlantTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_PlantTest;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_PlantTest;
...
void c3_PlantTest_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_PlantTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_PlantTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_PlantTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_PlantTest_method_dispatcher.\n"
