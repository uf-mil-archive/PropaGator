...
static void initialize_c1_PlantTest(SFc1_PlantTestInstanceStruct *chartInstance);
static void initialize_params_c1_PlantTest(SFc1_PlantTestInstanceStruct
  *chartInstance);
static void enable_c1_PlantTest(SFc1_PlantTestInstanceStruct *chartInstance);
static void disable_c1_PlantTest(SFc1_PlantTestInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_PlantTest(SFc1_PlantTestInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_PlantTest(SFc1_PlantTestInstanceStruct
  *chartInstance);
static void set_sim_state_c1_PlantTest(SFc1_PlantTestInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_PlantTest(SFc1_PlantTestInstanceStruct *chartInstance);
static void sf_c1_PlantTest(SFc1_PlantTestInstanceStruct *chartInstance);
static void c1_chartstep_c1_PlantTest(SFc1_PlantTestInstanceStruct
  *chartInstance);
static void initSimStructsc1_PlantTest(SFc1_PlantTestInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_PlantTestInstanceStruct *chartInstance,
  const mxArray *c1_v1, const char_T *c1_identifier, real_T c1_y[6]);
static void c1_b_emlrt_marshallIn(SFc1_PlantTestInstanceStruct *chartInstance,
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_PlantTestInstanceStruct *chartInstance,
...
static real_T c1_sind(SFc1_PlantTestInstanceStruct *chartInstance, real_T c1_x);
static boolean_T c1_isfinite(SFc1_PlantTestInstanceStruct *chartInstance, real_T
  c1_x);
static real_T c1_cosd(SFc1_PlantTestInstanceStruct *chartInstance, real_T c1_x);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_PlantTestInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_PlantTestInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_PlantTest, const char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_PlantTestInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sind(SFc1_PlantTestInstanceStruct *chartInstance, real_T *c1_x);
static void c1_b_cosd(SFc1_PlantTestInstanceStruct *chartInstance, real_T *c1_x);
static void init_dsm_address_info(SFc1_PlantTestInstanceStruct *chartInstance);
...
static void initialize_c1_PlantTest(SFc1_PlantTestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_PlantTest = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_PlantTest;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_PlantTest = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_PlantTest");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_PlantTest(chartInstance);
...
static void sf_c1_PlantTest(SFc1_PlantTestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_PlantTest(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_PlantTestMachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u[6];
  const mxArray *c1_y = NULL;
  SFc1_PlantTestInstanceStruct *chartInstance;
  chartInstance = (SFc1_PlantTestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_PlantTest_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_b_is_active_c1_PlantTest, const char_T *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_PlantTest), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_PlantTest);
  return c1_y;
}
...
void sf_c1_PlantTest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_PlantTest_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_PlantTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_PlantTest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_PlantTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"v1\",},{M[8],M[0],T\"is_active_c1_PlantTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_PlantTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_PlantTestInstanceStruct *chartInstance;
    chartInstance = (SFc1_PlantTestInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_PlantTestMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_PlantTestMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _PlantTestMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_PlantTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_PlantTestInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c1_PlantTest((SFc1_PlantTestInstanceStruct*)
    chartInstanceVar);
  initialize_c1_PlantTest((SFc1_PlantTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_PlantTest(void *chartInstanceVar)
{
  enable_c1_PlantTest((SFc1_PlantTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_PlantTest(void *chartInstanceVar)
{
  disable_c1_PlantTest((SFc1_PlantTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_PlantTest(void *chartInstanceVar)
{
  sf_c1_PlantTest((SFc1_PlantTestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_PlantTest(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_PlantTest((SFc1_PlantTestInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_PlantTest();/* state var info */
...
extern void sf_internal_set_sim_state_c1_PlantTest(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_PlantTest((SFc1_PlantTestInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_PlantTest(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_PlantTest(S);
}

static void sf_opaque_set_sim_state_c1_PlantTest(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_PlantTest(S, st);
}

static void sf_opaque_terminate_c1_PlantTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_PlantTestInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_PlantTest_optimization_info();
    }

    finalize_c1_PlantTest((SFc1_PlantTestInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_PlantTest((SFc1_PlantTestInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_PlantTest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_PlantTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_PlantTest_optimization_info();
...
static void mdlRTW_c1_PlantTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_PlantTest(SimStruct *S)
{
  SFc1_PlantTestInstanceStruct *chartInstance;
  chartInstance = (SFc1_PlantTestInstanceStruct *)utMalloc(sizeof
    (SFc1_PlantTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_PlantTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_PlantTest;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_PlantTest;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_PlantTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_PlantTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_PlantTest;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_PlantTest;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_PlantTest;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_PlantTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_PlantTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_PlantTest;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_PlantTest;
...
void c1_PlantTest_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_PlantTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_PlantTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_PlantTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_PlantTest_method_dispatcher.\n"
