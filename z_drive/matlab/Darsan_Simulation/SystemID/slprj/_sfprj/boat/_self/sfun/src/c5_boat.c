...
static void sf_gateway_c5_boat(SFc5_boatInstanceStruct *chartInstance);
static void c5_chartstep_c5_boat(SFc5_boatInstanceStruct *chartInstance);
...
static boolean_T c5_isfinite(SFc5_boatInstanceStruct *chartInstance, real_T c5_x);
static void c5_eml_scalar_eg(SFc5_boatInstanceStruct *chartInstance);
...
static void sf_gateway_c5_boat(SFc5_boatInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_boat(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_boatMachineNumber_,
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1655962737U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1261281755U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3764639196U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2064323950U);
}
...
mxArray *sf_c5_boat_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("OGtIbO1EJXRIr3qaWRc3iG");
...
mxArray *sf_c5_boat_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_boat_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_boatInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_boatMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _boatMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  sf_gateway_c5_boat((SFc5_boatInstanceStruct*) chartInstanceVar);
}
...
extern void sf_internal_set_sim_state_c5_boat(SimStruct* S, const mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_boat();/* state var info */
...
static void mdlProcessParameters_c5_boat(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c5_boat((SFc5_boatInstanceStruct*)
...
static void mdlSetWorkWidths_c5_boat(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1407390097U));
  ssSetChecksum1(S,(526248559U));
  ssSetChecksum2(S,(2444398425U));
  ssSetChecksum3(S,(1662852240U));
...
static void mdlStart_c5_boat(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_boatInstanceStruct *)utMalloc(sizeof
