...
static void sf_gateway_c6_boat(SFc6_boatInstanceStruct *chartInstance);
...
static void c6_eml_xgemm(SFc6_boatInstanceStruct *chartInstance, real_T c6_A[18],
...
static uint8_T c6_f_emlrt_marshallIn(SFc6_boatInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_eml_xgemm(SFc6_boatInstanceStruct *chartInstance, real_T c6_A
...
mxArray *sf_c6_boat_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_boat_updateBuildInfo_args_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_boatInstanceStruct *) chartInfo->chartInstance;
...
{
  sf_gateway_c6_boat((SFc6_boatInstanceStruct*) chartInstanceVar);
}
...
extern void sf_internal_set_sim_state_c6_boat(SimStruct* S, const mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_boat();/* state var info */
...
static void mdlProcessParameters_c6_boat(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c6_boat((SFc6_boatInstanceStruct*)
...
static void mdlStart_c6_boat(SimStruct *S)
{
  ...
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_boatInstanceStruct *)utMalloc(sizeof
