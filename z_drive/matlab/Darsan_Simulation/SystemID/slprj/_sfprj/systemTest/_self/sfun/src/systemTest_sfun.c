  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(186817000U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2530137836U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4080468647U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(643263383U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 11:
      {
        if (strcmp(aiChksum, "s4PgiUmiwT5EA4GQzZyaSH") == 0) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 11:
      {
        if (strcmp(tpChksum, "iqWKka2DguqxtXhIdSO1tG") == 0) {
