...
static void sf_gateway_c5_test(SFc5_testInstanceStruct *chartInstance);
...
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real_T c5_c_emlrt_marshallIn(SFc5_testInstanceStruct *chartInstance,
...
static real_T c5_cosd(SFc5_testInstanceStruct *chartInstance, real_T c5_x);
static boolean_T c5_isfinite(SFc5_testInstanceStruct *chartInstance, real_T c5_x);
static void c5_eml_scalar_eg(SFc5_testInstanceStruct *chartInstance);
static real_T c5_sind(SFc5_testInstanceStruct *chartInstance, real_T c5_x);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_d_emlrt_marshallIn(SFc5_testInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_e_emlrt_marshallIn(SFc5_testInstanceStruct *chartInstance,
...
static uint8_T c5_f_emlrt_marshallIn(SFc5_testInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_cosd(SFc5_testInstanceStruct *chartInstance, real_T *c5_x);
static void c5_b_sind(SFc5_testInstanceStruct *chartInstance, real_T *c5_x);
  ...
  *chartInstance)
{
  ...
  c5_hoistedGlobal = chartInstance->c5_is_active_c5_test;
  ...
  mxArray *c5_st)
{
  ...
  chartInstance->c5_is_active_c5_test = c5_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 1)), "is_active_c5_test");
  sf_mex_destroy(&c5_u);
  ...
  const mxArray *c5_b_is_active_c5_test, const char_T *c5_identifier)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_y = c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_is_active_c5_test),
    &c5_thisId);
...
mxArray *sf_c5_test_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_test(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"v1\",},{M[8],M[0],T\"is_active_c5_test\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_testInstanceStruct *) chartInfo->chartInstance;
...
{
  sf_gateway_c5_test((SFc5_testInstanceStruct*) chartInstanceVar);
}
...
extern void sf_internal_set_sim_state_c5_test(SimStruct* S, const mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_test();/* state var info */
...
static void mdlProcessParameters_c5_test(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c5_test((SFc5_testInstanceStruct*)
