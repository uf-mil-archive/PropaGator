...
static void sf_gateway_c6_test(SFc6_testInstanceStruct *chartInstance);
static void initSimStructsc6_test(SFc6_testInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_testInstanceStruct *chartInstance, const
  mxArray *c6_y, const char_T *c6_identifier, real_T c6_b_y[3]);
static void c6_b_emlrt_marshallIn(SFc6_testInstanceStruct *chartInstance, const
...
static void c6_eml_xgemm(SFc6_testInstanceStruct *chartInstance, real_T c6_A[18],
  real_T c6_B[6], real_T c6_C[3], real_T c6_b_C[3]);
static const mxArray *c6_e_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_d_emlrt_marshallIn(SFc6_testInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_e_emlrt_marshallIn(SFc6_testInstanceStruct *chartInstance,
...
static uint8_T c6_f_emlrt_marshallIn(SFc6_testInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_eml_xgemm(SFc6_testInstanceStruct *chartInstance, real_T c6_A
  [18], real_T c6_B[6], real_T c6_C[3]);
  ...
  *chartInstance)
{
  ...
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_test;
  ...
  mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_test = c6_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 1)), "is_active_c6_test");
  sf_mex_destroy(&c6_u);
  ...
  const mxArray *c6_b_is_active_c6_test, const char_T *c6_identifier)
{
  ...
  c6_thisId.fIdentifier = c6_identifier;
  c6_thisId.fParent = NULL;
  c6_y = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c6_b_is_active_c6_test),
    &c6_thisId);
...
mxArray *sf_c6_test_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_test(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c6_test\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_testInstanceStruct *) chartInfo->chartInstance;
...
{
  sf_gateway_c6_test((SFc6_testInstanceStruct*) chartInstanceVar);
}
...
extern void sf_internal_set_sim_state_c6_test(SimStruct* S, const mxArray *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_test();/* state var info */
...
static void mdlProcessParameters_c6_test(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c6_test((SFc6_testInstanceStruct*)
