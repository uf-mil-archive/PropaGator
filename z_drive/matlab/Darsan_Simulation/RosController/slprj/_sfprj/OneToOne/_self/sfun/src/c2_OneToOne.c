...
static const char * c2_debug_family_names[11] = { "R", "FxyM", "nargin",
  "nargout", "Fx", "Fy", "M", "phi", "fx", "fy", "m" };

/* Function Declarations */
static void initialize_c2_OneToOne(SFc2_OneToOneInstanceStruct *chartInstance);
static void initialize_params_c2_OneToOne(SFc2_OneToOneInstanceStruct
  *chartInstance);
static void enable_c2_OneToOne(SFc2_OneToOneInstanceStruct *chartInstance);
static void disable_c2_OneToOne(SFc2_OneToOneInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_OneToOne(SFc2_OneToOneInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_OneToOne(SFc2_OneToOneInstanceStruct
  *chartInstance);
static void set_sim_state_c2_OneToOne(SFc2_OneToOneInstanceStruct *chartInstance,
  const mxArray *c2_st);
static void finalize_c2_OneToOne(SFc2_OneToOneInstanceStruct *chartInstance);
static void sf_gateway_c2_OneToOne(SFc2_OneToOneInstanceStruct *chartInstance);
static void initSimStructsc2_OneToOne(SFc2_OneToOneInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_OneToOneInstanceStruct *chartInstance,
  const mxArray *c2_m, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_OneToOneInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_OneToOneInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[3]);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_OneToOneInstanceStruct *chartInstance,
...
static real_T c2_cosd(SFc2_OneToOneInstanceStruct *chartInstance, real_T c2_x);
static boolean_T c2_isfinite(SFc2_OneToOneInstanceStruct *chartInstance, real_T
  c2_x);
static real_T c2_sind(SFc2_OneToOneInstanceStruct *chartInstance, real_T c2_x);
static void c2_eml_scalar_eg(SFc2_OneToOneInstanceStruct *chartInstance);
static void c2_eml_xgemm(SFc2_OneToOneInstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[3], real_T c2_C[3], real_T c2_b_C[3]);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_OneToOneInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_OneToOneInstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_OneToOne, const char_T *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_OneToOneInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_cosd(SFc2_OneToOneInstanceStruct *chartInstance, real_T *c2_x);
static void c2_b_sind(SFc2_OneToOneInstanceStruct *chartInstance, real_T *c2_x);
static void c2_b_eml_xgemm(SFc2_OneToOneInstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[3], real_T c2_C[3]);
static void init_dsm_address_info(SFc2_OneToOneInstanceStruct *chartInstance);
...
static void initialize_c2_OneToOne(SFc2_OneToOneInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_OneToOne = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_c_hoistedGlobal = *c2_m;
  c2_c_u = c2_c_hoistedGlobal;
  c2_d_y = NULL;
  sf_mex_assign(&c2_d_y, sf_mex_create("y", &c2_c_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_y, 2, c2_d_y);
  c2_d_hoistedGlobal = chartInstance->c2_is_active_c2_OneToOne;
  ...
  const mxArray *c2_st)
{
  ...
  *c2_fy = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
    "fy");
  *c2_m = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
    "m");
  chartInstance->c2_is_active_c2_OneToOne = c2_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 3)), "is_active_c2_OneToOne");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_OneToOne(chartInstance);
...
static void sf_gateway_c2_OneToOne(SFc2_OneToOneInstanceStruct *chartInstance)
{
  ...
  int32_T c2_i0;
  int32_T c2_i1;
  static real_T c2_dv0[3] = { 0.0, 0.0, 1.0 };
  ...
  real_T *c2_b_Fy;
  real_T *c2_b_Fx;
  c2_b_phi = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  ...
  c2_b_Fy = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c2_b_fx = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_b_Fx = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c2_b_Fx, 0U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *c2_b_Fx;
  c2_b_hoistedGlobal = *c2_b_Fy;
  c2_c_hoistedGlobal = *c2_b_M;
  c2_d_hoistedGlobal = *c2_b_phi;
  c2_Fx = c2_hoistedGlobal;
  c2_Fy = c2_b_hoistedGlobal;
  c2_M = c2_c_hoistedGlobal;
  c2_phi = c2_d_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 11U, 11U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_R, 0U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_FxyM, 1U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Fx, 4U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_Fy, 5U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_M, 6U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_phi, 7U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_fx, 8U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_fy, 9U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_m, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c2_i3 = 0; c2_i3 < 3; c2_i3++) {
    ...
    for (c2_i5 = 0; c2_i5 < 3; c2_i5++) {
      c2_a[c2_i5 + c2_i2] = c2_R[c2_i4 + c2_i3];
      c2_i4 += 3;
    }
  ...
  for (c2_i8 = 0; c2_i8 < 9; c2_i8++) {
    c2_dv1[c2_i8] = c2_a[c2_i8];
  }

  for (c2_i9 = 0; c2_i9 < 3; c2_i9++) {
    c2_dv2[c2_i9] = c2_b[c2_i9];
  }

  for (c2_i10 = 0; c2_i10 < 9; c2_i10++) {
    c2_dv3[c2_i10] = c2_dv1[c2_i10];
  }
  ...
  c2_b_eml_xgemm(chartInstance, c2_dv3, c2_dv4, c2_FxyM);
  ...
  *c2_b_m = c2_m;
  ...
  _SFD_DATA_RANGE_CHECK(*c2_b_fx, 1U);
  _SFD_DATA_RANGE_CHECK(*c2_b_Fy, 2U);
  _SFD_DATA_RANGE_CHECK(*c2_b_M, 3U);
  _SFD_DATA_RANGE_CHECK(*c2_b_fy, 4U);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u;
  const mxArray *c2_y = NULL;
  SFc2_OneToOneInstanceStruct *chartInstance;
  chartInstance = (SFc2_OneToOneInstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c2_m, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_m), &c2_thisId);
  sf_mex_destroy(&c2_m);
  return c2_y;
}
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_OneToOneInstanceStruct *chartInstance;
  chartInstance = (SFc2_OneToOneInstanceStruct *)chartInstanceVoid;
  c2_FxyM = sf_mex_dup(c2_mxArrayInData);
  c2_identifier = c2_varName;
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_FxyM), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_FxyM);
  ...
  *c2_inData)
{
  ...
  for (c2_i17 = 0; c2_i17 < 3; c2_i17++) {
    for (c2_i18 = 0; c2_i18 < 3; c2_i18++) {
      c2_b_inData[c2_i18 + c2_i16] = (*(real_T (*)[9])c2_inData)[c2_i18 + c2_i16];
    }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i24 = 0; c2_i24 < 3; c2_i24++) {
    for (c2_i25 = 0; c2_i25 < 3; c2_i25++) {
      (*(real_T (*)[9])c2_outData)[c2_i25 + c2_i23] = c2_y[c2_i25 + c2_i23];
    }
...
const mxArray *sf_c2_OneToOne_get_eml_resolved_functions_info(void)
{
  const mxArray *c2_nameCaptureInfo = NULL;
  c2_nameCaptureInfo = NULL;
  sf_mex_assign(&c2_nameCaptureInfo, sf_mex_createstruct("structure", 2, 41, 1),
                false);
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("cosd"), "name", "name", 0);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 0);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cosd.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1343851972U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_cosd_and_sind.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1343851978U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 13);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("rdivide"), "name", "name", 13);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 16);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_div"), "name", "name", 16);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 16);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_rem90.m"),
                  "context", "context", 18);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("rem"), "name", "name", 18);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 18);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("sind"), "name", "name", 27);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  const mxArray *c2_b_is_active_c2_OneToOne, const char_T *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_OneToOne), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_OneToOne);
  return c2_y;
}
  ...
  c2_A[9], real_T c2_B[3], real_T c2_C[3])
{
  ...
  for (c2_i30 = 0; c2_i30 < 3; c2_i30++) {
    ...
    for (c2_i32 = 0; c2_i32 < 3; c2_i32++) {
      c2_C[c2_i30] += c2_A[c2_i31 + c2_i30] * c2_B[c2_i32];
      c2_i31 += 3;
    }
  }
}
...
void sf_c2_OneToOne_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1918890875U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1032918264U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4176857140U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3350737632U);
}

mxArray *sf_c2_OneToOne_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("HQm503MWmILAdwyCur14cD");
...
mxArray *sf_c2_OneToOne_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_OneToOne_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_OneToOne(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"fx\",},{M[1],M[8],T\"fy\",},{M[1],M[9],T\"m\",},{M[8],M[0],T\"is_active_c2_OneToOne\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_OneToOne_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_OneToOneInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c2_m;
          real_T *c2_phi;
          c2_phi = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
          c2_m = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
          c2_fy = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c2_M = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c2_Fy = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c2_fx = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c2_Fx = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c2_Fx);
          _SFD_SET_DATA_VALUE_PTR(1U, c2_fx);
          _SFD_SET_DATA_VALUE_PTR(2U, c2_Fy);
...
{
  return "qnp5G443LexPt5LTK9KrUH";
}

static void sf_opaque_initialize_c2_OneToOne(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_OneToOneInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_OneToOne((SFc2_OneToOneInstanceStruct*) chartInstanceVar);
  initialize_c2_OneToOne((SFc2_OneToOneInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_OneToOne(void *chartInstanceVar)
{
  enable_c2_OneToOne((SFc2_OneToOneInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_OneToOne(void *chartInstanceVar)
{
  disable_c2_OneToOne((SFc2_OneToOneInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_OneToOne(void *chartInstanceVar)
{
  sf_gateway_c2_OneToOne((SFc2_OneToOneInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_OneToOne(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_OneToOne((SFc2_OneToOneInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_OneToOne();/* state var info */
...
extern void sf_internal_set_sim_state_c2_OneToOne(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_OneToOne();/* state var info */
  ...
  set_sim_state_c2_OneToOne((SFc2_OneToOneInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_OneToOne(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_OneToOne(S);
}

static void sf_opaque_set_sim_state_c2_OneToOne(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_OneToOne(S, st);
}

static void sf_opaque_terminate_c2_OneToOne(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_OneToOneInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_OneToOne((SFc2_OneToOneInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_OneToOne((SFc2_OneToOneInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_OneToOne(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_OneToOne((SFc2_OneToOneInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_OneToOne(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3775624024U));
  ssSetChecksum1(S,(2782491315U));
  ssSetChecksum2(S,(3090405280U));
  ssSetChecksum3(S,(2158820935U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_OneToOne(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_OneToOne(SimStruct *S)
{
  SFc2_OneToOneInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_OneToOneInstanceStruct *)utMalloc(sizeof
    (SFc2_OneToOneInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_OneToOneInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_OneToOne;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_OneToOne;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_OneToOne;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_OneToOne;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_OneToOne;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_OneToOne;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_OneToOne;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_OneToOne;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_OneToOne;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_OneToOne;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_OneToOne;
...
void c2_OneToOne_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_OneToOne(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_OneToOne(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_OneToOne(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_OneToOne_method_dispatcher.\n"
