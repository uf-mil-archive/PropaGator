...
static void initialize_c1_OneToOne(SFc1_OneToOneInstanceStruct *chartInstance);
static void initialize_params_c1_OneToOne(SFc1_OneToOneInstanceStruct
  *chartInstance);
static void enable_c1_OneToOne(SFc1_OneToOneInstanceStruct *chartInstance);
static void disable_c1_OneToOne(SFc1_OneToOneInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_OneToOne(SFc1_OneToOneInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_OneToOne(SFc1_OneToOneInstanceStruct
  *chartInstance);
static void set_sim_state_c1_OneToOne(SFc1_OneToOneInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_OneToOne(SFc1_OneToOneInstanceStruct *chartInstance);
static void sf_gateway_c1_OneToOne(SFc1_OneToOneInstanceStruct *chartInstance);
static void initSimStructsc1_OneToOne(SFc1_OneToOneInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_OneToOneInstanceStruct *chartInstance,
  const mxArray *c1_requiredMomentZ, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_OneToOneInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_OneToOneInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_OneToOneInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_OneToOne, const char_T *c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_OneToOneInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_OneToOneInstanceStruct *chartInstance);
...
static void initialize_c1_OneToOne(SFc1_OneToOneInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_OneToOne = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_d_hoistedGlobal = chartInstance->c1_is_active_c1_OneToOne;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_requiredMomentZ = c1_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c1_is_active_c1_OneToOne = c1_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 3)), "is_active_c1_OneToOne");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_OneToOne(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u;
  const mxArray *c1_y = NULL;
  SFc1_OneToOneInstanceStruct *chartInstance;
  chartInstance = (SFc1_OneToOneInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_OneToOne_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_b_is_active_c1_OneToOne, const char_T *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_OneToOne), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_OneToOne);
  return c1_y;
}
...
void sf_c1_OneToOne_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_OneToOne_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_OneToOne_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_OneToOne_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_OneToOne(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"requiredForceX\",},{M[1],M[23],T\"requiredForceY\",},{M[1],M[24],T\"requiredMomentZ\",},{M[8],M[0],T\"is_active_c1_OneToOne\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_OneToOne_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_OneToOneInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c1_OneToOne(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_OneToOneInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c1_OneToOne((SFc1_OneToOneInstanceStruct*) chartInstanceVar);
  initialize_c1_OneToOne((SFc1_OneToOneInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_OneToOne(void *chartInstanceVar)
{
  enable_c1_OneToOne((SFc1_OneToOneInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_OneToOne(void *chartInstanceVar)
{
  disable_c1_OneToOne((SFc1_OneToOneInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_OneToOne(void *chartInstanceVar)
{
  sf_gateway_c1_OneToOne((SFc1_OneToOneInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_OneToOne(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_OneToOne((SFc1_OneToOneInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_OneToOne();/* state var info */
...
extern void sf_internal_set_sim_state_c1_OneToOne(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_OneToOne();/* state var info */
  ...
  set_sim_state_c1_OneToOne((SFc1_OneToOneInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_OneToOne(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_OneToOne(S);
}

static void sf_opaque_set_sim_state_c1_OneToOne(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_OneToOne(S, st);
}

static void sf_opaque_terminate_c1_OneToOne(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_OneToOneInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_OneToOne((SFc1_OneToOneInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_OneToOne((SFc1_OneToOneInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_OneToOne(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c1_OneToOne((SFc1_OneToOneInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_OneToOne(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_OneToOne(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_OneToOne(SimStruct *S)
{
  SFc1_OneToOneInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_OneToOneInstanceStruct *)utMalloc(sizeof
    (SFc1_OneToOneInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_OneToOneInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_OneToOne;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_OneToOne;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_OneToOne;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_OneToOne;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_OneToOne;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_OneToOne;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_OneToOne;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_OneToOne;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_OneToOne;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_OneToOne;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_OneToOne;
...
void c1_OneToOne_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_OneToOne(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_OneToOne(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_OneToOne(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_OneToOne_method_dispatcher.\n"
