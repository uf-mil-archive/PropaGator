...
static const char * c1_debug_family_names[23] = { "nargin", "nargout",
  ...
  "requiredForceX", "requiredForceY", "requiredForceyaw" };

/* Function Declarations */
static void initialize_c1_PDTest(SFc1_PDTestInstanceStruct *chartInstance);
static void initialize_params_c1_PDTest(SFc1_PDTestInstanceStruct *chartInstance);
static void enable_c1_PDTest(SFc1_PDTestInstanceStruct *chartInstance);
static void disable_c1_PDTest(SFc1_PDTestInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_PDTest(SFc1_PDTestInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_PDTest(SFc1_PDTestInstanceStruct
  *chartInstance);
static void set_sim_state_c1_PDTest(SFc1_PDTestInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_PDTest(SFc1_PDTestInstanceStruct *chartInstance);
static void sf_gateway_c1_PDTest(SFc1_PDTestInstanceStruct *chartInstance);
static void initSimStructsc1_PDTest(SFc1_PDTestInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_PDTestInstanceStruct *chartInstance,
  const mxArray *c1_requiredForceyaw, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_PDTestInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_PDTestInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_PDTestInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_PDTest, const char_T *c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_PDTestInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_PDTestInstanceStruct *chartInstance);
...
static void initialize_c1_PDTest(SFc1_PDTestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_PDTest = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T *c1_requiredForceyaw;
  c1_requiredForceyaw = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  ...
  c1_c_hoistedGlobal = *c1_requiredForceyaw;
  c1_c_u = c1_c_hoistedGlobal;
  c1_d_y = NULL;
  sf_mex_assign(&c1_d_y, sf_mex_create("y", &c1_c_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c1_y, 2, c1_d_y);
  c1_d_hoistedGlobal = chartInstance->c1_is_active_c1_PDTest;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_requiredForceyaw = c1_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c1_u, 2)), "requiredForceyaw");
  chartInstance->c1_is_active_c1_PDTest = c1_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 3)), "is_active_c1_PDTest");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_PDTest(chartInstance);
...
static void sf_gateway_c1_PDTest(SFc1_PDTestInstanceStruct *chartInstance)
{
  ...
  real_T *c1_b_requiredForceyaw;
  c1_b_requiredForceyaw = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_requiredForceY, 21U,
    c1_sf_marshallOut, c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_requiredForceyaw, 22U,
    c1_sf_marshallOut, c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c1_requiredForceyaw = c1_p_gain_yaw * (c1_yaw_desired - c1_yaw_current) +
  ...
  *c1_b_requiredForceyaw = c1_requiredForceyaw;
  ...
  _SFD_DATA_RANGE_CHECK(*c1_b_requiredForceyaw, 20U);
}
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u;
  const mxArray *c1_y = NULL;
  SFc1_PDTestInstanceStruct *chartInstance;
  chartInstance = (SFc1_PDTestInstanceStruct *)chartInstanceVoid;
  ...
  const mxArray *c1_requiredForceyaw, const char_T *c1_identifier)
{
  ...
  c1_y = c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_requiredForceyaw),
    &c1_thisId);
  sf_mex_destroy(&c1_requiredForceyaw);
  return c1_y;
}
...
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  const mxArray *c1_requiredForceyaw;
  const char_T *c1_identifier;
  emlrtMsgIdentifier c1_thisId;
  real_T c1_y;
  SFc1_PDTestInstanceStruct *chartInstance;
  chartInstance = (SFc1_PDTestInstanceStruct *)chartInstanceVoid;
  c1_requiredForceyaw = sf_mex_dup(c1_mxArrayInData);
...
const mxArray *sf_c1_PDTest_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_b_is_active_c1_PDTest, const char_T *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_PDTest), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_PDTest);
  return c1_y;
}
...
void sf_c1_PDTest_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(342558197U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3608446503U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3662655070U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(747784617U);
}

mxArray *sf_c1_PDTest_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("4IOA8i9OU1Iq6cXc9gVVHG");
...
mxArray *sf_c1_PDTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_PDTest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_PDTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"requiredForceX\",},{M[1],M[23],T\"requiredForceY\",},{M[1],M[24],T\"requiredForceyaw\",},{M[8],M[0],T\"is_active_c1_PDTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_PDTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_PDTestInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(20,2,0,1,"requiredForceyaw");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,716);
...

        {
          ...
          real_T *c1_requiredForceY;
          real_T *c1_requiredForceyaw;
          c1_requiredForceyaw = (real_T *)ssGetOutputPortSignal(chartInstance->S,
            3);
          ...
          _SFD_SET_DATA_VALUE_PTR(20U, c1_requiredForceyaw);
        }
      }
    } else {
...
{
  return "zebE0H9RTKk1jicip0FFlE";
}

static void sf_opaque_initialize_c1_PDTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_PDTestInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c1_PDTest((SFc1_PDTestInstanceStruct*) chartInstanceVar);
  initialize_c1_PDTest((SFc1_PDTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_PDTest(void *chartInstanceVar)
{
  enable_c1_PDTest((SFc1_PDTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_PDTest(void *chartInstanceVar)
{
  disable_c1_PDTest((SFc1_PDTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_PDTest(void *chartInstanceVar)
{
  sf_gateway_c1_PDTest((SFc1_PDTestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_PDTest(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_PDTest((SFc1_PDTestInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_PDTest();/* state var info */
...
extern void sf_internal_set_sim_state_c1_PDTest(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_PDTest();/* state var info */
  ...
  set_sim_state_c1_PDTest((SFc1_PDTestInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_PDTest(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_PDTest(S);
}

static void sf_opaque_set_sim_state_c1_PDTest(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_PDTest(S, st);
}

static void sf_opaque_terminate_c1_PDTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_PDTestInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_PDTest((SFc1_PDTestInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_PDTest((SFc1_PDTestInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_PDTest(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c1_PDTest((SFc1_PDTestInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_PDTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1265167951U));
  ssSetChecksum1(S,(153870338U));
  ssSetChecksum2(S,(2663571529U));
  ssSetChecksum3(S,(501875188U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_PDTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_PDTest(SimStruct *S)
{
  SFc1_PDTestInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_PDTestInstanceStruct *)utMalloc(sizeof
    (SFc1_PDTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_PDTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_PDTest;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_PDTest;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_PDTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_PDTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_PDTest;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_PDTest;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_PDTest;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_PDTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_PDTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_PDTest;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_PDTest;
...
void c1_PDTest_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_PDTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_PDTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_PDTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_PDTest_method_dispatcher.\n"
