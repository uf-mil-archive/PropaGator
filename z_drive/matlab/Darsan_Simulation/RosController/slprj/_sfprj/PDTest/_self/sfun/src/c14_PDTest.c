...
static void initialize_c14_PDTest(SFc14_PDTestInstanceStruct *chartInstance);
static void initialize_params_c14_PDTest(SFc14_PDTestInstanceStruct
  *chartInstance);
static void enable_c14_PDTest(SFc14_PDTestInstanceStruct *chartInstance);
static void disable_c14_PDTest(SFc14_PDTestInstanceStruct *chartInstance);
static void c14_update_debugger_state_c14_PDTest(SFc14_PDTestInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c14_PDTest(SFc14_PDTestInstanceStruct
  *chartInstance);
static void set_sim_state_c14_PDTest(SFc14_PDTestInstanceStruct *chartInstance,
  const mxArray *c14_st);
static void finalize_c14_PDTest(SFc14_PDTestInstanceStruct *chartInstance);
static void sf_gateway_c14_PDTest(SFc14_PDTestInstanceStruct *chartInstance);
static void initSimStructsc14_PDTest(SFc14_PDTestInstanceStruct *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static void c14_emlrt_marshallIn(SFc14_PDTestInstanceStruct *chartInstance,
  const mxArray *c14_y, const char_T *c14_identifier, real_T c14_b_y[3]);
static void c14_b_emlrt_marshallIn(SFc14_PDTestInstanceStruct *chartInstance,
...
static const mxArray *c14_b_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static void c14_c_emlrt_marshallIn(SFc14_PDTestInstanceStruct *chartInstance,
  const mxArray *c14_x, const char_T *c14_identifier, real_T c14_y[6]);
static void c14_d_emlrt_marshallIn(SFc14_PDTestInstanceStruct *chartInstance,
...
static const mxArray *c14_d_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_e_emlrt_marshallIn(SFc14_PDTestInstanceStruct *chartInstance,
...
static void c14_eml_scalar_eg(SFc14_PDTestInstanceStruct *chartInstance);
static void c14_eml_xgemm(SFc14_PDTestInstanceStruct *chartInstance, real_T
...
static const mxArray *c14_e_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static int32_T c14_f_emlrt_marshallIn(SFc14_PDTestInstanceStruct *chartInstance,
  const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static uint8_T c14_g_emlrt_marshallIn(SFc14_PDTestInstanceStruct *chartInstance,
  const mxArray *c14_b_is_active_c14_PDTest, const char_T *c14_identifier);
static uint8_T c14_h_emlrt_marshallIn(SFc14_PDTestInstanceStruct *chartInstance,
  const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_b_eml_xgemm(SFc14_PDTestInstanceStruct *chartInstance, real_T
  c14_A[18], real_T c14_B[6], real_T c14_C[3]);
static void init_dsm_address_info(SFc14_PDTestInstanceStruct *chartInstance);
...
static void initialize_c14_PDTest(SFc14_PDTestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_PDTest = 0U;
}
  ...
  *chartInstance)
{
  ...
  c14_hoistedGlobal = chartInstance->c14_is_active_c14_PDTest;
  ...
  const mxArray *c14_st)
{
  ...
  chartInstance->c14_is_active_c14_PDTest = c14_g_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c14_u, 2)), "is_active_c14_PDTest");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_PDTest(chartInstance);
  ...
  *c14_inData)
{
  ...
  real_T c14_u[3];
  const mxArray *c14_y = NULL;
  SFc14_PDTestInstanceStruct *chartInstance;
  chartInstance = (SFc14_PDTestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c14_PDTest_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c14_b_is_active_c14_PDTest, const char_T *c14_identifier)
{
  ...
  c14_y = c14_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_PDTest), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_PDTest);
  return c14_y;
}
...
void sf_c14_PDTest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c14_PDTest_get_autoinheritance_info(void)
{
...
mxArray *sf_c14_PDTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c14_PDTest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c14_PDTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[11],T\"x\",},{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c14_PDTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_PDTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc14_PDTestInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c14_PDTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_PDTestInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c14_PDTest((SFc14_PDTestInstanceStruct*) chartInstanceVar);
  initialize_c14_PDTest((SFc14_PDTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c14_PDTest(void *chartInstanceVar)
{
  enable_c14_PDTest((SFc14_PDTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_PDTest(void *chartInstanceVar)
{
  disable_c14_PDTest((SFc14_PDTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c14_PDTest(void *chartInstanceVar)
{
  sf_gateway_c14_PDTest((SFc14_PDTestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_PDTest(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_PDTest((SFc14_PDTestInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_PDTest();/* state var info */
...
extern void sf_internal_set_sim_state_c14_PDTest(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c14_PDTest();/* state var info */
  ...
  set_sim_state_c14_PDTest((SFc14_PDTestInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_PDTest(SimStruct* S)
{
  return sf_internal_get_sim_state_c14_PDTest(S);
}

static void sf_opaque_set_sim_state_c14_PDTest(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c14_PDTest(S, st);
}

static void sf_opaque_terminate_c14_PDTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_PDTestInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c14_PDTest((SFc14_PDTestInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc14_PDTest((SFc14_PDTestInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_PDTest(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c14_PDTest((SFc14_PDTestInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c14_PDTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c14_PDTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_PDTest(SimStruct *S)
{
  SFc14_PDTestInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc14_PDTestInstanceStruct *)utMalloc(sizeof
    (SFc14_PDTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_PDTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c14_PDTest;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c14_PDTest;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c14_PDTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c14_PDTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c14_PDTest;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c14_PDTest;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c14_PDTest;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c14_PDTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_PDTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_PDTest;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c14_PDTest;
...
void c14_PDTest_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_PDTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_PDTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_PDTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_PDTest_method_dispatcher.\n"
