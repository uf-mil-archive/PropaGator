...
for l = 1:length(data)
    ...
    ForceX(i)   = requiredForceX(data(l).x_current(i), data(l).x_desired(i), data(l).x_velocity_current(i), data(l).x_velocity_desired(i));
    ForceY(i)   = requiredForceX(data(l).y_current(i), data(l).y_desired(i), data(l).y_velocity_current(i), data(l).y_velocity_desired(i));
    MomentZ(i)  = requiredForceX(data(l).yaw_current(i), data(l).yaw_desired(i), data(l).yaw_velocity_current(i), data(l).yaw_velocity_desired(i));
