"""autogenerated by genpy from path_planner/FindBuoysActionResult.msg. Do not edit."""
import sys
...
class FindBuoysActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "path_planner/FindBuoysActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','path_planner/FindBuoysResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FindBuoysActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = path_planner.msg.FindBuoysResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = path_planner.msg.FindBuoysResult()
