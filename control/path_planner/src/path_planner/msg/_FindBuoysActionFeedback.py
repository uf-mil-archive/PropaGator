"""autogenerated by genpy from path_planner/FindBuoysActionFeedback.msg. Do not edit."""
import sys
...
class FindBuoysActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "path_planner/FindBuoysActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','path_planner/FindBuoysFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FindBuoysActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = path_planner.msg.FindBuoysFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = path_planner.msg.FindBuoysFeedback()
