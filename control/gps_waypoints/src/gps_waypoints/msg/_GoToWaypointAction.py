...
class GoToWaypointAction(genpy.Message):
  _md5sum = "7c8c30ee11d31cce1fdedd376e9cba80"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3I.pack(_x.action_goal.goal.waypoint.x, _x.action_goal.goal.waypoint.y, _x.action_goal.goal.waypoint.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.waypoint.x, _x.action_goal.goal.waypoint.y, _x.action_goal.goal.waypoint.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
