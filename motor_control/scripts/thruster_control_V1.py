...
##  servo class. 
##  A ramping function then moves the current value to the desired value
...
#These are the valuse that the thrusters attempt to achieve in newtons
starboard_setpoint = 0.0
port_setpoint = 0.0
#Values that the thrusters are currently at in newtons
port_current = 0.0
...
#               Sets up ROS enviorment an executes functionality
