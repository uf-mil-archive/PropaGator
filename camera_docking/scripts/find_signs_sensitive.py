...
#**************** while(cap.isOpened()): *************************************************************
    ...
    ret,thresh = cv2.threshold(imgray,100,255,cv2.THRESH_TOZERO) #Adjust the first digit after imgray to increase sensitivity to white boards. Used 230 for UF pool testing.
