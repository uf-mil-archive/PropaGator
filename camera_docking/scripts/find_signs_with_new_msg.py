...
distance_from_center = 28.0 #distance used to ensure no overlapping contours are used
...
class image_converter:
  ...
  def __init__(self):
    ...
    self.docksign = rospy.Publisher('Docksign', DockSign, queue_size = 1)
...
#################################################################################################################################################################
    ...
    if (corner[0] < corner[4] and corner[0] < corner[8] and corner[0] != width):
        ...
        if sign1[0] != 'none':        
            ...
            dksn.shape = sign1[0]
            dksn.xpixel = sign1[2]+corner[0] - 500
            dksn.color = sign1[4]
        ...
        if sign3[0] != 'none':        
            ...
            dksn.shape = sign3[0]
            dksn.xpixel = sign3[2]+corner[0] - 500
            dksn.color = sign3[4]  
        ...
        if sign2[0] != 'none':        
            ...
            dksn.shape = sign2[0]
            dksn.xpixel = sign2[2]+corner[0] - 500
            dksn.color = sign2[4]
    ...
    if (corner[4] < corner[0] and corner[4] < corner [8] and corner[4] != width and corner[4] != width):
        ...
        if sign1[0] != 'none':        
            ...
            dksn.shape = sign1[0]
            dksn.xpixel = sign1[2]+corner[4] - 500
            dksn.color = sign1[4]
        ...
        if sign3[0] != 'none':        
            ...
            dksn.shape = sign3[0]
            dksn.xpixel = sign3[2]+corner[4] - 500
            dksn.color = sign3[4]
        ...
        if sign2[0] != 'none':        
            ...
            dksn.shape = sign2[0]
            dksn.xpixel = sign2[2]+corner[4] - 500
            dksn.color = sign2[4]
    ...
    if (corner[8] < corner[4] and corner[8] < corner [0] and corner[8] != width):
        ...
        if sign1[0] != 'none':        
            ...
            dksn.shape = sign1[0]
            dksn.xpixel = sign1[2]+corner[8] - 500
            dksn.color = sign1[4]
        ...
        if sign3[0] != 'none':        
            ...
            dksn.shape = sign3[0]
            dksn.xpixel = sign3[2]+corner[8] - 500
            dksn.color = sign3[4]
        ...
        if sign2[0] != 'none':        
            ...
            dksn.shape = sign2[0]
            dksn.xpixel = sign2[2]+corner[8] - 500
            dksn.color = sign2[4]
