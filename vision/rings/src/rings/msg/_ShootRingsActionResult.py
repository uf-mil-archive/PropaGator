"""autogenerated by genpy from rings/ShootRingsActionResult.msg. Do not edit."""
import sys
...
class ShootRingsActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "rings/ShootRingsActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rings/ShootRingsResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ShootRingsActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rings.msg.ShootRingsResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rings.msg.ShootRingsResult()
