"""autogenerated by genpy from rings/ShootRingsAction.msg. Do not edit."""
import sys
...
class ShootRingsAction(genpy.Message):
  _md5sum = "ada53d5113871d9e5a940010b5b691f0"
  _type = "rings/ShootRingsAction"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

ShootRingsActionGoal action_goal
ShootRingsActionResult action_result
ShootRingsActionFeedback action_feedback

================================================================================
MSG: rings/ShootRingsActionGoal
...
================================================================================
MSG: rings/ShootRingsActionResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalStatus status
ShootRingsResult result
...
================================================================================
MSG: rings/ShootRingsResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
# result
#not used

================================================================================
MSG: rings/ShootRingsActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalStatus status
ShootRingsFeedback feedback

================================================================================
MSG: rings/ShootRingsFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
# feedback
uint32 darts_shot
...
"""
  ...
  _slot_types = ['rings/ShootRingsActionGoal','rings/ShootRingsActionResult','rings/ShootRingsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ShootRingsAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = rings.msg.ShootRingsActionGoal()
      if self.action_result is None:
        self.action_result = rings.msg.ShootRingsActionResult()
      if self.action_feedback is None:
        self.action_feedback = rings.msg.ShootRingsActionFeedback()
    else:
      self.action_goal = rings.msg.ShootRingsActionGoal()
      self.action_result = rings.msg.ShootRingsActionResult()
      self.action_feedback = rings.msg.ShootRingsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.color
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3I.pack(_x.action_goal.goal.orientation.x, _x.action_goal.goal.orientation.y, _x.action_goal.goal.orientation.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_I.pack(self.action_feedback.feedback.darts_shot))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.color = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.color = str[start:end]
      _x = self
      start = end
      end += 36
      (_x.action_goal.goal.orientation.x, _x.action_goal.goal.orientation.y, _x.action_goal.goal.orientation.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.darts_shot,) = _struct_I.unpack(str[start:end])
      return self
