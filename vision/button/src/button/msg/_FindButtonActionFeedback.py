"""autogenerated by genpy from button/FindButtonActionFeedback.msg. Do not edit."""
import sys
...
class FindButtonActionFeedback(genpy.Message):
  ...
  _type = "button/FindButtonActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','button/FindButtonFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = button.msg.FindButtonFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = button.msg.FindButtonFeedback()
