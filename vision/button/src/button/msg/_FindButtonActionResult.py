"""autogenerated by genpy from button/FindButtonActionResult.msg. Do not edit."""
import sys
...
class FindButtonActionResult(genpy.Message):
  ...
  _type = "button/FindButtonActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','button/FindButtonResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = button.msg.FindButtonResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = button.msg.FindButtonResult()
