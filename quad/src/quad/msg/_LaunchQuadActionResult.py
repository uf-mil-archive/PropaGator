"""autogenerated by genpy from quad/LaunchQuadActionResult.msg. Do not edit."""
import sys
...
class LaunchQuadActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "quad/LaunchQuadActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','quad/LaunchQuadResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LaunchQuadActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = quad.msg.LaunchQuadResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = quad.msg.LaunchQuadResult()
