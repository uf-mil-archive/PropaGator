"""autogenerated by genpy from quad/FindButtonActionFeedback.msg. Do not edit."""
import sys
...
class FindButtonActionFeedback(genpy.Message):
  ...
  _type = "quad/FindButtonActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','quad/FindButtonFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = quad.msg.FindButtonFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = quad.msg.FindButtonFeedback()
