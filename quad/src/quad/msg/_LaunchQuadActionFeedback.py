"""autogenerated by genpy from quad/LaunchQuadActionFeedback.msg. Do not edit."""
import sys
...
class LaunchQuadActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "quad/LaunchQuadActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','quad/LaunchQuadFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LaunchQuadActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = quad.msg.LaunchQuadFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = quad.msg.LaunchQuadFeedback()
