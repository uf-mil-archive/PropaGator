"""autogenerated by genpy from laser_tf_py/SweepLidarActionResult.msg. Do not edit."""
import sys
...
class SweepLidarActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "laser_tf_py/SweepLidarActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','laser_tf_py/SweepLidarResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SweepLidarActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = laser_tf_py.msg.SweepLidarResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = laser_tf_py.msg.SweepLidarResult()
