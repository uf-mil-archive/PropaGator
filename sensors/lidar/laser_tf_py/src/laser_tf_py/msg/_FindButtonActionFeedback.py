"""autogenerated by genpy from laser_tf_py/FindButtonActionFeedback.msg. Do not edit."""
import sys
...
class FindButtonActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "laser_tf_py/FindButtonActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','laser_tf_py/FindButtonFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FindButtonActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = laser_tf_py.msg.FindButtonFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = laser_tf_py.msg.FindButtonFeedback()
