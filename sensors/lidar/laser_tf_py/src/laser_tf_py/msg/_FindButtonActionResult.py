"""autogenerated by genpy from laser_tf_py/FindButtonActionResult.msg. Do not edit."""
import sys
...
class FindButtonActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "laser_tf_py/FindButtonActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','laser_tf_py/FindButtonResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FindButtonActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = laser_tf_py.msg.FindButtonResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = laser_tf_py.msg.FindButtonResult()
